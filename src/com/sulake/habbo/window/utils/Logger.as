package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1550:ICoreWindowManager;
      ...
      {
         var_1550 = param2 as ICoreWindowManager;
         _window = var_1550.create("Logger::Output",HabboWindowType.const_399,WindowStyle.const_288,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_356 = var_1550.create("Logger::Output::Text",HabboWindowType.const_2,WindowStyle.const_288,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
