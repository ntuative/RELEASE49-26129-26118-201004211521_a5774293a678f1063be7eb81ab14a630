package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1044:UserDataManager;
      ...
      {
         if(var_32 == RoomSessionEvent.const_301 && _connection != null)
         {
            var_32 = RoomSessionEvent.const_99;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1044 as IUserDataManager;
      }
