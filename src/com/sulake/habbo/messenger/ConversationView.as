package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_795:int = 100;
       
      
      private var var_2212:IScrollbarWindow;
      
      private var var_123:HabboMessenger;
      
      private var var_1584:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_123 = param1;
         var_1584 = initButton("follow_friend",onFollowButtonClick,param2);
         var_48 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2212 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      {
         if(param1 == Message.const_628)
         {
            return 4285887861;
         }
         if(param1 == Message.const_536)
         {
            return 4285887861;
         }
         return 4278190080;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_623 || param3.type == Message.const_727 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_539.messages.length - const_795);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_539.messages.length)
         {
            refreshEntry(true,_loc1_,var_539.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_539 == null || _loc1_.id != var_539.id)
         {
            var_539 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_795 + const_1134)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_123.send(new FollowFriendMessageComposer(var_539.id));
      }
