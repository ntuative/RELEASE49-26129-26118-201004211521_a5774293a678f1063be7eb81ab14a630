package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_564:Conversations;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_299:MessengerView;
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_924,_loc2_.senderId,getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function startConversation(param1:int) : void
      {
         var _loc2_:Conversation = var_564.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_564.setSelected(_loc2_);
            var_299.openMessenger();
            var_299.refresh(true);
         }
      }
      ...
      {
         var_564.addMessageAndUpdateView(param1);
         if(!var_299.isMessengerOpen())
         {
      ...
      {
         var_564 = new Conversations(new ConversationsDeps(this));
         var_299 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_183,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.MESSENGER));
      ...
      {
         var_564.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         var_564.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_851,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_564.addMessageAndUpdateView(_loc3_);
      }
