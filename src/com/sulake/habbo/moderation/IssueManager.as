package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1001:String = "issue_bundle_open";
      
      public static const const_725:String = "issue_bundle_my";
      
      public static const const_922:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_131 = new Map();
         var_859 = new Map();
         var_596 = new IssueBrowser(this,var_59.windowManager,var_59.assets);
         var_707 = [];
         var_860 = [];
         var_1028 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1028.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_131)
         {
            switch(param1)
            {
               case const_1001:
                  ...
                  break;
               case const_725:
                  if(_loc4_.state == IssueMessageData.const_470 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1145)
         {
            var_158.remove(param1.issueId);
            return;
         }
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1028.remove(param1);
         var_1028.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_470 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_1028.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_470 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
