package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_723:OffenceCategoryData;
      ...
      private var var_880:IDropMenuWindow;
      
      private var var_50:IFrameWindow;
      
      private var var_724:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_882 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_881 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_880.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1286,var_423.text,getBanLength(),var_1287));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_880.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1286,var_423.text,var_1287));
         this.dispose();
      }
      ...
      {
         return WindowTracker.const_1231;
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_723 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1286,var_423.text,var_1287));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_723 != null;
         if(this.var_724 != null)
         {
            var_50.findChildByName("offence_txt").caption = this.var_724.name;
            var_50.findChildByName("offence_category").visible = true;
         }
         else if(this.var_723 != null)
         {
            this.refreshButtons("offences_cont",2,var_723.offences,var_882,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_881,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_724 = var_723.offences[_loc3_];
         var_423.text = var_724.msg;
         var_314 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_50.caption = "Mod action on: " + var_1529;
         ...
         var_880 = IDropMenuWindow(var_50.findChildByName("banLengthSelect"));
         prepareBanSelect(var_880);
