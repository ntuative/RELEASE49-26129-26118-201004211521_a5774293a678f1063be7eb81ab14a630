package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1406:IIssueBrowserView;
      ...
      private var var_1404:IIssueBrowserView;
      
      private const const_1666:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1643:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_218:ITabContextWindow;
      
      private var var_1405:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_218 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_218.numTabItems)
            {
               _loc5_ = var_218.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_218.selector.getSelectableByName("open_issues");
         var_218.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_334.view.width = var_218.container.width;
         var_334.view.height = var_218.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1643:
               if(var_1404 == null)
               {
                  var_1404 = new MyIssuesView(issueManager,this,var_218.container);
               }
               return var_1404;
            case const_1645:
               if(var_1406 == null)
               {
                  var_1406 = new OpenIssuesView(issueManager,this,var_218.container);
               }
               return var_1406;
            case const_1644:
               if(var_1405 == null)
               {
                  var_1405 = new PickedIssuesView(issueManager,this,var_218.container);
               }
               return var_1405;
            default:
               return null;
