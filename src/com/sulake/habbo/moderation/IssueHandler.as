package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         var_451 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_1101 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_451.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_117.getHighestPriorityIssue().reporterUserId);
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_59,WindowTracker.const_976,_loc2_),_window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_451 = new UserInfoCtrl(_window,var_59,_loc3_.message);
            var_451.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
