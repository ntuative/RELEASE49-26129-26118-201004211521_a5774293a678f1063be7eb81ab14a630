package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1015:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_660,_data.flatId),var_50,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_449);
         if(param1.flatId != var_449)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_449);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1167,_loc2_,var_423.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1015.isSelected,var_1014.isSelected,var_695.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1301);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1265);
      }
      ...
      public function populate() : void
      {
         ...
         var_695 = ICheckBoxWindow(var_50.findChildByName("kick_check"));
         var_1015 = ICheckBoxWindow(var_50.findChildByName("lock_check"));
         var_1014 = ICheckBoxWindow(var_50.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_449));
         Logger.log("BEGINNING TO SHOW: " + var_449);
      }
   }
}
