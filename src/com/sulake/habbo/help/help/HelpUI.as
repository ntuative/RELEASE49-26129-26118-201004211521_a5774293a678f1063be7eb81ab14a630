package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1767:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26129-26118-201004211448");
         var_190 = param5;
         var_98 = new Map();
         var_98.add(HabboHelpViewEnum.const_1269,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_138,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_418,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_274,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_236,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_587,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_292,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_509,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_211,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         var_98.add(HabboHelpViewEnum.CALL_FOR_HELP_HAS_ABUSIVE_ITEM,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_abusive")));
         var_98.add(HabboHelpViewEnum.const_991,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_713,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_257 == HabboHelpViewEnum.const_138 || false)
         {
            return;
         }
         if(var_399 == null)
      ...
      {
         return var_98.getValue(var_257);
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_98.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_98.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_1769 = param1;
         var _loc2_:IHelpViewController = var_98.getValue(HabboHelpViewEnum.const_138) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_211:
               showUI(HabboHelpViewEnum.const_211);
               break;
            case CallForHelpResultEnum.const_1025:
      ...
      {
         var _loc3_:* = null;
         if(var_257 == HabboHelpViewEnum.const_138)
         {
            return;
         }
         if(true)
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = var_98.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_190 != null)
            {
               var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_21.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_411));
      }
