package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1499:uint = 13232628;
      
      private static var var_1980:uint = 11129827;
      ...
      private var var_861:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_47.localization.registerParameter("help.tutorial.name.available","name",var_353);
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1288 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1107 || param1 == ChangeUserNameResultMessageEvent.var_1108)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_861 = new NameSuggestionListRenderer(var_47);
         var _loc6_:int = var_861.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1499;
