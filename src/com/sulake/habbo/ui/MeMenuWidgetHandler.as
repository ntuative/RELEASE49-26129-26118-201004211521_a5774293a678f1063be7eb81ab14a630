   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_51,3);
               _loc2_ = _loc6_.getCroppedImage(AvatarSetType.const_51);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_998,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_410,onHelpTutorialEvent);
         ...
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_866,onAvatarEffectsChanged);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1024,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_410,onHelpTutorialEvent);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_511);
         _loc1_.push(RoomWidgetDanceMessage.const_547);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_506);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_592);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_676);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_723);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_705);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_555);
         _loc1_.push(RoomWidgetStopEffectMessage.const_683);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1212);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_859);
         _loc1_.push(RoomWidgetToolbarMessage.const_599);
         _loc1_.push(RoomWidgetToolbarMessage.const_724);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_611);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1303);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_865);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_703);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_529);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_614);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1256);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_564);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_563);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_743);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_621));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_529:
               ...
               break;
            case RoomWidgetWaveMessage.const_511:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_547:
               if(_container != null && false)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_506:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_592:
               if(var_10 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_676:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_555:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_896)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_205,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_705:
               ...
               if(var_10 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_879:
                        _catalog.openCatalogPage(CatalogPageName.const_1274,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_821:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1403:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1354:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_723:
            ...
            case RoomWidgetToolbarMessage.const_599:
               ...
               if(var_190)
               {
                  var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_724:
               ...
               if(var_190 && false)
               {
                  var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_469,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_611:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_443));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_614:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_285,_container.soundManager.volume));
               break;
            ...
            case RoomWidgetStoreSettingsMessage.const_563:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_285,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_743:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_409));
               }
               break;
            default:
