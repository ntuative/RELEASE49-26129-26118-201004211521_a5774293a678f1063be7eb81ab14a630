package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1658:String = "room_widget";
      
      private const const_1111:String = "room_view";
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_51.getChildByTag(const_1111) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_51.findChildByTag(const_1111) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_735;
               _loc2_.width = var_51.desktop.width - var_735;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_735;
               _loc2_.height = var_51.desktop.height - var_735;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_51.desktop.width;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1658) == 0)
            {
