package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_898:IHabboHelp = null;
      ...
      private var var_857:IRoomWidgetFactory = null;
      ...
      private var var_1962:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_303,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_395,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_708,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_705 = _roomEngine.loadRoomResources(var_35.roomResources);
            if(false)
            {
               var_1251 = false;
         ...
         if(var_277 != null && true)
         {
            var_1250 = !var_277.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_35.roomId,var_35.roomCategory,var_271[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_303,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_395,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_708,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_18 = null;
         var_857 = null;
         ...
         if(var_190 && false)
         {
            ...
            var_190.events.removeEventListener(HabboToolbarEvent.const_63,onHabboToolbarEvent);
         }
         var_190 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1962);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_190 != null)
         {
            var_172.toolbarSize = var_190.size;
            var_172.toolbarOrientation = var_190.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_857.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_682:
               ...
               if(var_744 != null && _loc3_ == RoomObjectCategoryEnum.const_39)
               {
                  _loc7_ = var_35.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_287)
                  {
                     var_744.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_260:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_120:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_955,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_539);
            _loc13_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_641);
            _loc14_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_557);
            _loc15_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_569);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_456:
               ...
               var_171 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_297,WindowStyle.const_288,WindowParam.const_90) as IToolTipWindow;
      ...
      {
         if(var_705 == null || false)
         {
            return;
         }
         var _loc2_:int = var_705.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      {
         if(var_18 != null && var_35 != null && var_1250 && var_1251)
         {
