package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_344);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_892);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_978);
            ...
            case RoomObjectCategoryEnum.const_39:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_287)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_912)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_737);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_209)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_690);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1210;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_971;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_849;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1399);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_589.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_589.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_690);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_272);
         _loc1_.push(RoomWidgetFurniActionMessage.const_637);
         _loc1_.push(RoomWidgetFurniActionMessage.const_693);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_515);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_747);
         _loc1_.push(RoomWidgetUserActionMessage.const_1193);
         _loc1_.push(RoomWidgetPetCommandMessage.const_649);
         _loc1_.push(RoomWidgetPetCommandMessage.const_510);
      ...
      public function dispose() : void
      {
         ...
         if(var_589 != null)
         {
            _loc1_ = var_589.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_589.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_369)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_662:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_966,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_516:
               ...
               break;
            case RoomWidgetUserActionMessage.const_747:
            ...
            case RoomWidgetUserActionMessage.const_426:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_515:
