package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_442:
               ...
               {
                  case RoomSessionQueueEvent.const_807:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_835:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc7_.length > 1)
               {
                  if(_loc6_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_1029) != -1)
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1029) + 1;
                     _loc9_ = true;
                  }
                  else
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1219) + 1;
                  }
               }
               else
               {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_579);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_835);
               break;
            case RoomWidgetRoomQueueMessage.const_579:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_807);
               break;
            case RoomWidgetRoomQueueMessage.const_738:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_205,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_442];
      }
