package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_928:Number = 0;
      
      private var var_540:Point = null;
      
      private var var_766:Map = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_542.length)
            {
               _loc2_ = var_542.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_542.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_766.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    ...
                                    default:
                                       ...
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_51).clone();
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_542.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_766.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_709,RoomWidgetChatSelectAvatarMessage.const_590];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_709:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_146,_container.roomSession,0,"Version 26129-26118-201004211448");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_590:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_928 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_928);
            }
            if(var_540 == null)
            {
               var_541.x = 0;
               var_541.y = 0;
               var_541.z = 0;
               var_540 = _loc4_.getScreenPoint(var_541);
               var_928 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_541.x = 0;
            var_541.y = 0;
            var_541.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_541);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_540.x || _loc8_.y != var_540.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_540,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_322;
      }
