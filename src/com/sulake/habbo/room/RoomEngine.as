package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_756:String = "overlay";
      ...
      private var var_431:IRoomObjectVisualizationFactory = null;
      ...
      private var var_559:NumberBank;
      ...
      private var var_656:RoomMessageHandler = null;
      
      private var var_655:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_298 = new Map();
         var_559 = new NumberBank(1000);
         var_972 = new Map();
         var_297 = new Map();
         var_63 = new RoomObjectEventHandler(this);
         var_656 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_63 != null)
         {
            ...
            {
               return var_63.deleteWallItem(var_108,var_107,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_298.length; _loc2_++)
         {
            _loc3_ = var_298.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_539) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_557) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_641) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_151);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_63 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_63.modifyWallItemData(var_108,var_107,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_431 != null)
         {
            var_431.release(new IIDRoomObjectVisualizationFactory());
            var_431 = null;
         }
         if(var_39 != null)
         {
         ...
         if(var_655 != null)
         {
            var_655.release(new IIDRoomRendererFactory());
            var_655 = null;
         }
         ...
         if(var_298 != null)
         {
            ...
            {
               _loc2_ = var_298.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_655.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_891;
         ...
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_719);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_622);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_983);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1007);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_833) > 0)
               {
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_550,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_517,var_108,var_107,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_63 != null)
         {
            return var_63.modifyRoomObject(var_108,var_107,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_297.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_297.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_698,param3);
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_615,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_39 != null)
         {
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.const_34);
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.const_32);
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.const_39);
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.const_67);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_63 != null)
         {
            var_63.handleRoomObjectEvent(param1,var_108,var_107);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_344,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_311,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_817,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_892,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_978,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_260,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_664,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_27 == null || var_431 == null || var_39 == null || var_655 == null || _communication == null || _habboConfiguration == null || !var_1658)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_281,RoomObjectCategoryEnum.const_67);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1199,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_107,var_1136);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_107,var_1136);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_431 = param2 as IRoomObjectVisualizationFactory;
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_431;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_27 != null)
         {
            if(false)
            {
               var_27.events.addEventListener(RoomObjectMouseEvent.const_230,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_400,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_263,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_632,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_120,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_132,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_112,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_130,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_131,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_122,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_97,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_439,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_445,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_392,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_430,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_405,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_406,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_481,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectMoveEvent.const_367,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMoveEvent.const_472,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_261,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_446,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_298,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_290,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_476,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_963,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_394,roomObjectEventHandler);
               var_27.events.addEventListener(AvatarWalkWarpingWarningEvent.const_374,warningEventHandler);
            }
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_198;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(var_63 != null)
         {
            return var_63.initializeRoomObjectInsert(var_108,var_107,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_297.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_260,param1,param2,param3,RoomObjectCategoryEnum.const_39));
         }
         return true;
      }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_344,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_311,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_891,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_260,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_277.events.addEventListener(AdEvent.const_468,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_756) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_298.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_584,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_655 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_39.getRoom(const_491);
         if(_loc10_ == null)
         {
            _loc10_ = var_39.createRoom(const_491,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_559.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_39:
               ...
               break;
            case RoomObjectCategoryEnum.const_67:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_530,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_635,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_514,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_452,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_972.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_949,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_559.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_755,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1409 - _loc12_.width / 2;
               _loc11_.y = var_1408 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_428,var_108,var_107,-1,RoomObjectCategoryEnum.const_198));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_63 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_281,const_490);
                  var_63.handleRoomObjectEvent(_loc14_,var_108,var_107);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_107,var_1136);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1409 - _loc6_.data.width / 2;
               _loc11_.y = var_1408 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_286,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_822,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_877,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_918,RoomObjectVariableEnum.const_286,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_298.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_298.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_63 != null)
         {
            var_63.cancelRoomObjectInsert(var_108,var_107);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_39.getRoom(const_491);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_949);
               ...
               var_559.freeNumber(_loc10_ - 1);
               _loc13_ = var_972.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_108,var_107,const_281,RoomObjectCategoryEnum.const_67,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_818,param6,true);
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_847,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_281,const_490,_loc8_) as IRoomObjectController;
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_539,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_641,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_557,_loc18_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1022,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_698,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_615,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_452,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_204);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_719,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_622,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_719,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_622,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_983,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1007,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_755,const_1054,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_757,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
