package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_789:String = "tile_cursor";
      
      private static const const_283:String = "RCL_PUBLICROOM_";
      ...
      private static const const_1127:String = const_354;
      
      private static const const_1442:int = 0;
      ...
      private var var_1080:IEventDispatcher = null;
      
      private var var_1331:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_531 = [];
         var_532 = [];
         var_2184 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2182 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_445 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_34:
                     if(var_531.indexOf(_loc4_) == -1)
                     {
                        var_531.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_32:
                     if(var_532.indexOf(_loc4_) == -1)
                     {
                        var_532.push(_loc4_);
                     }
                     break;
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_303,_loc4_);
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_444 != null)
         {
            _loc2_ = var_444.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_283 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(var_179 != null && var_179.hasWorldType(const_283 + param1))
         {
            return var_179.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_530.add(_loc10_,_loc11_);
                              if(var_531.indexOf(_loc14_) < 0)
                              {
                                 var_531.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_532.indexOf(_loc14_) < 0)
                              {
                                 var_532.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_445 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_445.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_361 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_361.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_445.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_623.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_445.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_354,const_502,ROOM_CONTENT,const_789,const_787];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2184.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_181 && _loc5_ != RoomObjectLogicEnum.const_118)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_624.getValue(param1) != null)
         {
            return var_624.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2182.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1331.add(_loc5_,_loc8_);
               var_179 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_303,_loc5_);
         }
         else
         {
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_179 != null && (var_179.type == param1 || var_179.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_67;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_67;
      ...
      private function continueInitilization() : void
      {
         if(var_2183)
         {
            ...
            if(var_1080 != null)
            {
               var_1080.dispatchEvent(new Event(const_558));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_179 != null)
         {
            return var_179.getWorldHeightScale(const_283 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1080 = param1;
            var_2185 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2186 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2187 = param2.getKey("public.room.dynamic.download.url","");
            var_2181 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_32 = const_788;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_361.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_443 != null)
         {
            ...
            var_443.add(param1,param2);
         }
         if(var_444 != null)
         {
            var_444.remove(param2);
            var_444.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_181 && _loc5_ != RoomObjectVisualizationEnum.const_118)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_431.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_283 + param1) == RoomObjectCategoryEnum.const_67)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1331.getValue(param1) != null)
         {
            var_179 = var_1331.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_179 != null)
         {
            return var_179.getWorldScale(const_283 + param1);
         }
         return 32;
      }
