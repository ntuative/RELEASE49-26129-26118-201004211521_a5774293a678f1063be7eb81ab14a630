package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1601:int = 1500;
      
      private var var_1602:int = 255;
      
      private var var_1603:int = 255;
      
      private var var_1378:uint = 16777215;
      
      private var var_1103:uint = 16777215;
      
      protected var var_75:RoomPlaneParser = null;
      
      private var var_938:int = 0;
      
      private var var_1223:int = 255;
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_698:
                  _loc2_.setString(RoomObjectVariableEnum.const_530,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_686:
                  _loc2_.setString(RoomObjectVariableEnum.const_635,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_615:
                  _loc2_.setString(RoomObjectVariableEnum.const_514,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_452:
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_550:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_977,_loc10_);
            }
            return;
         }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_616,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1156,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1227,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1202,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_142 || _loc13_ == RoomPlaneData.const_268)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_938)
         {
            ...
            {
               _loc7_ = var_1378 >> 16 & 255;
               _loc8_ = var_1378 >> 8 & 255;
               _loc9_ = var_1378 & 255;
               _loc10_ = var_1103 >> 16 & 255;
               _loc11_ = var_1103 >> 8 & 255;
               _loc12_ = var_1103 & 255;
               _loc13_ = (_loc2_ - var_938) / var_1601;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1602 + (var_1603 - var_1602) * _loc13_;
               _color = _loc3_;
               var_1223 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_616,_loc3_);
         }
      }
   }
}
