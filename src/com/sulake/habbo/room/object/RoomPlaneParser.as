package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_883;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_937);
         addPlane(RoomPlaneData.const_142,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_142,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_116) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_142,Vector3d.sum(param1,Vector3d.product(param3,-var_116 / param3.length)),Vector3d.product(param3,(param3.length + var_116) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_937 / param2.length);
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_757 = getFloorHeight(var_102);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_372 || param1 == var_373)
               {
                  _loc5_ = false;
                  _loc6_ = var_371;
                  while(_loc6_ < var_374)
                  {
               ...
               if(param2 == var_371 || param2 == var_374)
               {
                  _loc7_ = false;
                  _loc8_ = var_372;
                  while(_loc8_ < var_373)
                  {
