package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_745:AvatarVisualizationData = null;
      ...
      {
         var_745 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc9_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_652);
         var _loc10_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_593);
         ...
         var _loc13_:int = param2 - var_1314;
         ...
         var _loc15_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_309);
         if(_loc15_ > 0)
         {
         ...
         var _loc17_:Boolean = var_442 || var_522 > 0;
         if(_loc16_ || _loc17_)
         {
            increaseUpdateId();
            --var_522;
            ...
            if(var_319 != _loc7_)
            {
               for each(_loc40_ in var_360.getKeys())
               {
                  _loc41_ = var_360.getValue(_loc40_) as IAvatarImage;
                  if(_loc41_)
                  {
                     _loc41_.dispose();
                  }
                  var_360.remove(_loc40_);
               }
               if(_loc6_)
               {
                  _loc6_.dispose();
            ...
            if(_loc6_ == null)
            {
               _loc42_ = _loc4_.getString(RoomObjectVariableEnum.const_982);
               _loc6_ = var_745.getAvatar(_loc7_,param1.scale,_loc42_);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc21_ = _loc4_.getNumber(RoomObjectVariableEnum.const_343);
            ...
            _loc6_.appendAction(AvatarAction.const_598,_loc22_,_loc23_);
            _loc24_ = false;
            if(_loc22_ == "lay")
            {
               _loc43_ = int(_loc23_);
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_384);
            if(_loc25_ > 0 && _loc6_.getScale() == AvatarScaleType.const_56)
            {
               _loc44_ = _loc4_.getNumber(RoomObjectVariableEnum.const_378);
               _loc45_ = 3;
               _loc46_ = param2 - _loc44_;
               if(_loc46_ < _loc45_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_319,AvatarAction.const_1189[_loc25_]);
               }
            }
            _loc26_ = _loc4_.getNumber(RoomObjectVariableEnum.const_905);
            if(_loc26_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_953,_loc26_);
            }
            _loc27_ = _loc4_.getNumber(RoomObjectVariableEnum.const_839);
            if(_loc27_ > 0)
            {
               _loc47_ = _loc4_.getNumber(RoomObjectVariableEnum.const_910);
               _loc48_ = 5;
               _loc49_ = param2 - _loc47_;
               if(_loc49_ < _loc48_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_959,_loc27_);
               }
            }
            _loc28_ = _loc4_.getNumber(RoomObjectVariableEnum.const_737);
            _loc29_ = 0;
            if(_loc28_ > 0)
            {
               _loc50_ = _loc4_.getNumber(RoomObjectVariableEnum.const_733);
               _loc51_ = 100;
               _loc52_ = param2 - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_1012,_loc28_);
                  _loc53_ = 1;
                  while(_loc53_ < 10)
                  {
            ...
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_972);
            if(_loc29_ > 0)
            {
               _loc30_ = _loc29_;
            }
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_927,_loc30_);
            }
            if(_loc8_)
            {
               _loc6_.appendAction(AvatarAction.const_361);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_373) > 0;
            if(_loc31_ || _loc12_)
            {
            ...
            if(_loc14_)
            {
               _loc6_.appendAction(AvatarAction.const_449);
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_875);
            if(_loc32_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_531,_loc32_);
            }
            ...
            if(_loc22_ == "mv" || _loc22_ == "std")
            {
               ...
               if(var_521 != null)
               {
                  _loc35_.asset = var_521.content as BitmapData;
            ...
            var_523 = null;
            _loc35_ = getSprite(const_1660);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_1021))
            {
               _loc35_.visible = true;
               switch(param1.scale)
               {
                  case 32:
                     var_523 = var_745.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
                     _loc67_ = 3;
                     _loc68_ = -42;
                     break;
                  case 64:
                     var_523 = var_745.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
                     _loc67_ = 14;
                     _loc68_ = -83;
               }
               if(var_523 != null)
            ...
            var_899.push(getTimer() - _loc19_);
            if(false)
            {
               _loc69_ = 0;
               _loc70_ = "[";
               for each(_loc71_ in var_899)
               {
                  _loc69_ += _loc71_;
                  _loc70_ += "," + _loc71_;
               }
