package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1155:int = const_327;
      ...
      public static const const_217:int = 4;
      
      public static const const_618:int = 6;
      
      public static const ALIGN_DEFAULT:int = const_104;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1402 == const_104)
         {
            _loc5_ = new Rectangle(0,0,var_23.width,var_332);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_332,var_23.width,var_332);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_23 != null)
            {
               if(var_23.width == param2 && var_23.height == param3 && Vector3d.isEqual(var_554,param4))
               {
                  if(param1 != null)
                  {
