package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_767:int = 15;
      
      private static const const_1060:int = 2;
      
      private static const const_353:int = 2;
      
      private static const const_768:int = 31;
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_991 = new Array();
         var_991.push(Math.random() * _loc2_ * 1.5);
         var_991.push(Math.random() * _loc2_ * 1.5);
         var_990 = new Array();
         var_990.push(1);
         var_990.push(-1);
         var_989 = new Array();
         var_989.push(const_1060);
         var_989.push(const_1061);
         var_992 = new Array();
