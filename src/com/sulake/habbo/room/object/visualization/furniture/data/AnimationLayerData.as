package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = var_198[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!var_1519)
         {
            ...
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < var_198.length)
            {
               _loc2_ = var_198[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc2_ = var_198[_loc7_] as AnimationFrameSequenceData;
      ...
      {
         if(param1 < 0 || param1 >= var_198.length)
         {
            return null;
         }
         var _loc4_:AnimationFrameSequenceData = var_198[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
