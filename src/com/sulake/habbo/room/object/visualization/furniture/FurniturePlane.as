package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         var_588 = new Vector3d();
         var_588.assign(param2);
         var_587 = new Vector3d();
         var_587.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_1901)
         {
            if(!param1)
            {
               var_263.assign(var_588);
               var_264.assign(var_587);
            }
            else
            {
               var_263.assign(var_588);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_69 == null && var_776 != null || var_263 == null || var_264 == null || var_459 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1220)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1013 || _loc4_.y != var_1690 || _loc4_.z != var_1683 || param1.scale != var_1684))
            {
               var_1013 = _loc4_.x;
               var_1690 = _loc4_.y;
               var_1683 = _loc4_.z;
