package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_874);
      ...
      {
         if(param1 < var_592.length)
         {
            return var_592[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_225 != null)
         {
            ...
            {
               _loc2_ = var_225[_loc3_];
               _loc2_.update(var_592,var_1945,param1);
               _loc3_++;
            }
