package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_714 = RenderMode.const_1370;
         if(param1 is CoreComponent)
         {
            var_25 = CoreComponent(param1);
            var_25.events.addEventListener(Component.COMPONENT_EVENT_RUNNING,onComponentsRunning);
         }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_80:
               _loc3_ = var_239.getValue(AvatarType.const_80) as AvatarStructure;
               break;
            case AvatarType.PET:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_239.getValue(AvatarType.const_80) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc5_:* = null;
         var _loc1_:AssetLibraryCollection = var_25.assets as AssetLibraryCollection;
         var _loc2_:int = 0;
         ...
         var_239.add(AvatarType.const_80,_loc5_);
      ...
      {
         return var_762 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_714 = param1;
         if(var_714 == RenderMode.const_1166)
         {
            init();
         }
         if(var_714 == RenderMode.const_1348)
         {
            init();
      ...
      {
         var _loc5_:String = var_762.createAvatarFigureString(param1,param2,param3);
      ...
      {
         var _loc4_:AvatarStructure = var_239.getValue(AvatarType.const_80) as AvatarStructure;
         if(_loc4_ == null)
         {
            return null;
         }
