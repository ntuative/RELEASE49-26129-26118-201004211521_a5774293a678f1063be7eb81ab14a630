package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2080:PartOffsetData;
      
      private var var_879:AvatarActionManager;
      
      private var var_175:IAssetLibrary;
      
      private var var_1057:IAssetLibrary;
      
      private var var_2079:AvatarRenderManager;
      
      private var var_313:FigureData;
      ...
      private var var_1527:AvatarStructureDownloadSet;
      
      private var var_1283:Array;
      
      private var var_721:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_175 = param2;
         var_1057 = param3;
         var_313 = new FigureData();
         var_421 = new PartSetsData();
         _animationData = new AnimationData();
         var_1527 = new AvatarStructureDownloadSet();
         var_721 = new AnimationManager();
         var_722 = param4;
         var_2080 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_879.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_879.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_313.appendXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_879.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_721.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1187[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_879.getDefaultActionType();
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc10_ = var_721.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_313.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_313.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_722 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_722)
         {
            case AvatarType.const_80:
               ...
               var_1527.add(new AvatarStructureDownload(var_175,_loc5_,var_313));
               break;
            case AvatarType.PET:
         }
         var_1527.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_721.getAnimation(param1);
      }
      ...
      {
         var_879 = new AvatarActionManager(var_175,var_722);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1283 = var_313.getMandatorySetTypeIds();
         return var_1283;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_313.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1057.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1057.getAssetByName("dance" + _loc1_).content as XML;
            var_721.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1057.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1057.getAssetByName("fx" + _loc1_).content as XML;
            var_721.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_313.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_313.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_879.sortActions(param1);
      }
   }
}
