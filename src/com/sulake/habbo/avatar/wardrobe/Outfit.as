package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IAvatarImage = var_47.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL,var_604);
         if(_loc1_)
         {
            _loc1_.setDirection(AvatarSetType.const_41,int(FigureData.const_702));
