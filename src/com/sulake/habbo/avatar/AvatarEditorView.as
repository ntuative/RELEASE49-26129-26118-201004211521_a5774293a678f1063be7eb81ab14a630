package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1380:IWindowContainer;
      ...
      private var var_1433:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_471:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1380 == null)
         {
            ...
            var_1380 = var_47.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1609 == null)
         {
      ...
      private function createWindow() : void
      {
         ...
         var_1433 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         update();
      }
      ...
      public function update() : void
      {
         ...
         if(var_47.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1434 == AvatarEditorSideCategory.WARDROBE || var_1735))
         {
            _loc4_ = "null";
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_471)
         {
            ...
            var_471 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_471.procedure = stripClubDialogEventProc;
            var_471.center();
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_651:
               break;
            case AvatarEditorSideCategory.const_466:
               _loc3_ = var_47.getSideContentWindowContainer(AvatarEditorSideCategory.const_466);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_257 = param1;
         var_1433.setSelected(var_1433.getSelectableByName(param1));
         _window.invalidate();
      }
      
      private function toggleWardrobe() : void
      {
         if(var_1434 == AvatarEditorSideCategory.WARDROBE)
         {
            var_1735 = false;
            setSideContent(AvatarEditorSideCategory.const_651);
         }
         else
         {
