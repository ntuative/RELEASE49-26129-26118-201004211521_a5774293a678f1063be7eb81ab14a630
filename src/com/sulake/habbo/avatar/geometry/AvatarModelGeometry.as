package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_478:Matrix4x4;
      
      private var var_830:Vector3D;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_830 = new Vector3D(0,0,10,0);
         super();
         var_478 = new Matrix4x4();
         var_685 = new Dictionary();
         var_1462 = new AvatarSet(param1.avatarset[0]);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_478 = var_478.identity().rotateY(param3);
            return _loc5_.getParts(var_478,var_830,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1462.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_478 = var_478.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_478);
            _loc11_ = _loc8_.getDistance(var_830);
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1462.findAvatarSet(param1);
         if(_loc3_ != null)
         {
