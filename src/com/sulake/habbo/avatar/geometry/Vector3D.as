package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      private var var_1043:Number;
      
      private var var_79:Number;
      
      private var _y:Number;
      
      private var var_80:Number;
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.x = _y * param1.z - var_80 * param1.y;
         _loc2_.y = var_80 * param1.x - var_79 * param1.z;
         _loc2_.z = var_79 * param1.y - _y * param1.x;
         return _loc2_;
      }
      ...
      {
         return Math.sqrt(var_79 * var_79 + _y * _y + var_80 * var_80);
      }
      ...
      {
         return var_79 * param1.x + _y * param1.y + var_80 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_79 + "," + _y + "," + var_80 + "," + var_1043 + ")";
      }
