package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_138.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_138.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_609)
                  {
                     if(_loc18_.action != null)
                     {
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_52.getParts(param1,(var_823 as AvatarImage).getFigure(),_loc6_,var_1303,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_52.getCanvas(var_205,var_1303);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc23_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1330[param1])
            {
            ...
            else
            {
               ...
               if((_loc29_ == AvatarAction.const_832 || _loc29_ == AvatarAction.const_542) && (_loc6_ == AvatarBodyPartType.const_318 || _loc6_ == AvatarBodyPartType.const_1205 || _loc6_ == AvatarBodyPartType.const_1252) && _loc7_.color != null)
               {
         ...
         if(_loc17_)
         {
            if(var_205 == AvatarScaleType.const_56)
            {
               _loc25_.x += 67;
            }
            else
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_138 != null)
         {
            _loc2_ = var_138.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_138.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
