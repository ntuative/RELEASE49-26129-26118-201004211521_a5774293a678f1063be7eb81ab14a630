package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_873:AvatarEditorHandler;
      ...
      private const const_1100:int = 2;
      
      private var _catalog:IHabboCatalog;
      
      private var var_10:IHabboInventory;
      
      private var var_604:String = "M";
      
      private var var_147:IHabboConfigurationManager;
      
      private var var_715:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_715.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_162)
         {
            ...
            var_494["null"] = new FigureData(this);
            var_494["null"] = new FigureData(this);
            _loc1_ = var_494["null"];
            _loc2_ = var_494["null"];
            _loc1_.loadAvatarData("hr-681-35.hd-209-7.ch-878-87.lg-281-70.sh-906-77.ea-1401-77.ha-1010-70.he-1601-62.fa-1204-62.ca-1809-62.wa-2007-62",FigureData.const_91);
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_88);
            var_87 = new Map();
            var_417 = new Map();
            var_87.add(AvatarEditorFigureCategory.const_928,new BodyModel(this));
            var_87.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            var_87.add(AvatarEditorFigureCategory.const_318,new TorsoModel(this));
            var_87.add(AvatarEditorFigureCategory.const_1275,new LegsModel(this));
            var_87.add(AvatarEditorFigureCategory.const_1343,new HotLooksModel(this));
            var_417.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_417.add(AvatarEditorSideCategory.const_466,new ClubPromoModel(this));
            var_162 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1045 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1517;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1045 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1100)
                  {
            ...
            if(_loc9_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1380.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1255)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1045 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1380.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_417.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_873 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_715.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_417.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(_windowContext == null)
            {
               _windowContext = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_60,HabboWindowStyle.const_42,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_928);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_715 = _avatarRenderManager.getFigureData(AvatarType.const_80);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (_avatarRenderManager as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1045 = param3;
         var _loc4_:FigureData = var_494[param2];
         if(_loc4_ == null)
         {
            return;
         }
