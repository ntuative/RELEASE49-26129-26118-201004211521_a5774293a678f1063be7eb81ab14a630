package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_725 >= 0 && var_176.length > var_725)
         {
            _loc2_ = var_176[var_725];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_176.length > param1)
         {
            _loc3_ = var_176[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = var_229[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(var_229.length <= param1)
         {
            return null;
         }
         return var_229[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return var_176[var_725] as AvatarEditorGridPartItem;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_229)
         {
            for each(_loc2_ in var_229 as Array)
            {
               if(_loc2_)
               {
