package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(_view != null)
         {
            var_498 = _view.findChildByName("part_thumbs") as IItemGridWindow;
            var_422 = new Array();
         ...
         if(param1.type == WindowMouseEvent.const_52)
         {
            ...
            while(_loc7_ < const_1100)
            {
               if(var_422.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     _model.selectColor(var_1182,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = _model.getCategoryData(var_1182);
         if(!_loc1_)
         {
            return;
         }
         ...
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               var_498.addGridItem(_loc2_.view);
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_52)
         {
            _loc3_ = var_498.getGridItemIndex(param1.window);
            _model.selectPart(var_1182,_loc3_);
         }
      }
