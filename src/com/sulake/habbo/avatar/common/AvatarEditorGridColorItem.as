package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         var_824 = _loc5_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_824.width,var_824.height,true,0);
            _loc5_ = var_824.clone();
            ...
            if(var_676)
            {
               switch(var_676.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_59:
                     _loc4_.style = HabboIconType.const_639;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_53:
                     _loc4_.style = HabboIconType.const_626;
                     _loc4_.visible = true;
               }
            }
            else
