package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1563,var_1561,var_1562,_alphaMultiplier);
         var_1007 = generatePaletteMapForGrayscale(var_1831,var_1830);
      }
      
      public function get reds() : Array
      {
         return var_1007.getValue("reds") as Array;
      }
      ...
      {
         return var_1007.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1007.getValue("greens") as Array;
      }
      ...
      {
         return var_1007.getValue("alphas") as Array;
      }
