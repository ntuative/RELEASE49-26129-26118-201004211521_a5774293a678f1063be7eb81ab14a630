package com.sulake.habbo.communication.messages.incoming.notifications
{
   ...
   public class HabboAchievementNotificationMessageEvent extends MessageEvent implements IMessageEvent
   {
      ...
      {
         return (var_6 as HabboAchievementNotificationMessageParser).type;
      }
      
      public function get level() : int
      {
         return (var_6 as HabboAchievementNotificationMessageParser).level;
      }
      
      public function get removedBadgeID() : String
      {
         return (var_6 as HabboAchievementNotificationMessageParser).removedBadgeID;
      }
      
      public function get badgeID() : String
      {
         return (var_6 as HabboAchievementNotificationMessageParser).badgeID;
      }
   }
}
