package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1332:
            case DisconnectReasonEvent.const_1263:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1393:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1371:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1988)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_708 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_708);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1255,var_1987));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1427,"/");
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1427,"/");
      ...
      {
         var_708 = _habboConfiguration.getKey("sso.ticket",null);
         var_1255 = _habboConfiguration.getKey("flash.client.url","");
         var_1987 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_173 == null)
         {
         ...
         if(var_708 != null)
         {
            var_64.mode = HabboConnectionType.const_465;
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_687);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(var_64.mode)
         {
            case HabboConnectionType.const_465:
               _loc6_ = "";
               ...
               var_1030 = _loc4_;
               var_173.loadBannerImage(_loc7_ + "?token=" + var_1030,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1013:
               sendConnectionParameters(_loc2_);
               break;
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1030);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_64.mode = HabboConnectionType.const_1013;
            }
         }
         var_64.initConnection(HabboConnectionType.const_259);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_203);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_168,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_105,onRoomSessionEnded);
      }
