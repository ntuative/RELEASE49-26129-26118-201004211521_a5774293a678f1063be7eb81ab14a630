package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         var_363.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_363)
         {
            var_363.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_363.reset();
            var_363 = null;
         }
         if(var_321)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_49 == null)
         {
            var_49 = IWindowContainer(_navigator.getXmlWindow(var_1275));
            var_49.visible = false;
         ...
         var_49.x = _loc2_.x + var_2117 + param1.width;
