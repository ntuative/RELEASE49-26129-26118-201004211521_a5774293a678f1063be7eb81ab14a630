package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1579,this._model.mode != ThumbnailEditorModel.const_57);
         setEnabled(var_1578,this._model.mode != ThumbnailEditorModel.const_36);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1579 = IButtonWindow(find("top_tab"));
         var_1578 = IButtonWindow(find("obj_tab"));
         var_2198 = IWindowContainer(find("tile_grid"));
         var_2197 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1579,onTopTabButton);
         Util.setProcDirectly(var_1578,onObjTabButton);
      }
      ...
      {
         var _loc1_:IWindowContainer = var_2197;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_60,HabboWindowStyle.const_42,HabboWindowParam.const_75,new Rectangle(0,0,param1.width,66)));
