package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1720 = this._navigator.getButtonImage(this.var_1721);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1719 == null)
         {
            ...
            this.var_1719 = new Rectangle(var_1426,var_1426,_loc1_.width - 2 * var_1426,_loc1_.height - 2 * var_1426);
         }
         var_658.bitmap.fillRect(var_658.bitmap.rect,4281545523);
         var_658.bitmap.fillRect(this.var_1719,4284900966);
         copyTo(var_658.bitmap);
         if(_selected)
         {
            var_658.bitmap.copyPixels(var_1718,var_1718.rect,new Point(0,0),null,null,true);
         }
         var_658.invalidate();
      }
