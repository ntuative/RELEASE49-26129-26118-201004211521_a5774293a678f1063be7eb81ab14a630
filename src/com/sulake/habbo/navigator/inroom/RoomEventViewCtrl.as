package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1813:IButtonWindow;
      
      private var var_1192:IButtonWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1812.text = _navigator.getText("roomevent_type_" + param1.eventType);
         ...
         var_1194.visible = true;
         var_1193.visible = true;
         var_1454.visible = false;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1812 = ITextWindow(find("event_type_disabled_text"));
            var_1454 = ITextWindow(find("create_caption"));
            var_1456 = ITextWindow(find("edit_caption"));
            var_1192 = IButtonWindow(find("create_button"));
            var_1194 = IButtonWindow(find("edit_button"));
            var_1813 = IButtonWindow(find("cancel_button"));
            var_1193 = IButtonWindow(find("end_button"));
            var_820 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1192,onCreateButtonClick);
            Util.setProcDirectly(var_1194,onEditButtonClick);
            Util.setProcDirectly(var_1193,onEndButtonClick);
            Util.setProcDirectly(var_1813,onCancelButtonClick);
      ...
      private function createEvent() : void
      {
         ...
         var_1192.visible = true;
         var_1194.visible = false;
