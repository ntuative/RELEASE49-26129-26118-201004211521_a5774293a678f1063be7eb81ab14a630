package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1131:int = 267;
      
      private static const const_1132:int = 65;
      
      private static const const_1133:int = -70;
      ...
      private var var_853:UserCountRenderer;
      ...
      public function OfficialRoomListCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_853 = new UserCountRenderer(_navigator);
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_227,Tabs.const_284,_loc2_.tag);
         }
      ...
      private function refreshPublicSpaceImage(param1:IWindowContainer, param2:OfficialRoomEntryData, param3:IBitmapWrapperWindow) : void
      {
         ...
         param3.x = !!param2.showDetails ? int(const_1133) : 0;
         param3.width = 274;
      ...
      private function method_4(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:OfficialRoomEntryData) : Boolean
      {
         ...
         if(param1)
         {
            ...
            if(param3.type == OfficialRoomEntryData.const_1363)
            {
               method_4(_loc4_,param3);
            }
            else
            {
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1132) : int(const_1131);
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_525 || param2.type == OfficialRoomEntryData.const_661))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_853.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
      ...
      public function getPopupDesc(param1:OfficialRoomEntryData) : String
      {
         ...
         if(param1.publicRoomData != null)
         {
            return _navigator.method_5(param1.publicRoomData.unitPropertySet,param1.publicRoomData.worldId);
         }
         return "";
      }
