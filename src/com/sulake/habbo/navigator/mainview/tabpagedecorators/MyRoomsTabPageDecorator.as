package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_520:IDropMenuWindow;
      
      private var var_2394:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_679;
         }
         if(param1 == 2)
         {
            return Tabs.const_674;
         }
         if(param1 == 3)
         {
         ...
         return Tabs.const_206;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_520 == null ? 0 : int(var_520.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_520 == null)
         {
            var_520 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_520.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
