package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_533 = new Timer(100);
         var_533.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_38 = new Array();
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,104,"a"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,94,"b"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,36,"c"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,84,"d"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"e"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"f"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,416,"i"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,320,"j"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,448,"k"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,352,"l"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,384,"m"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,372,"n"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_59,80,"g"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_59,74,"h"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_59,416,"o"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_59,352,"p"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_59,304,"q"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_59,336,"r"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_59,748,"u"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_59,438,"v"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,540,"t"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,512,"w"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,396,"x"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,440,"y"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,456,"z"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1081 = new TextFieldManager(_navigator,ITextFieldWindow(var_19.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_533)
         {
            var_533.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_533.reset();
            var_533 = null;
         }
      }
      ...
      {
         var_1081.goBackToInitialState();
         var_1081.input.textBackgroundColor = 4294967295;
         var_913 = var_38[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_60,HabboWindowStyle.const_42,HabboWindowParam.const_75,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1081.getText();
      ...
      {
         var _loc1_:Boolean = var_1081.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!var_1332 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1332 = true;
            _loc3_.y = 1;
