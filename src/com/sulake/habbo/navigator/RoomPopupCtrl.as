package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_2202:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2202 = new RoomThumbnailRenderer(param1);
         var_812 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_180,var_114.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_180.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_180.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_812.refreshTags(_loc1_,var_114.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2202.refreshThumbnail(_loc1_,var_114.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_180 == null)
         {
            var_180 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_180.visible = true;
         Util.hideChildren(var_180);
         refreshRoomName(var_180,var_114);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_180,!true ? getEventCtg(var_114.categoryId) : getRoomCtg(var_114.categoryId));
         refreshRoomDesc(var_180,var_114);
         refreshExtraCont();
         refreshInfo(var_180,"trading_allowed",var_114.allowTrading);
         refreshInfo(var_180,"doormode_doorbell",false);
         refreshInfo(var_180,"doormode_password",false);
         Util.moveChildrenToColumn(var_180,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_180.height = Util.getLowestPoint(var_180);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_227,Tabs.const_224,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
