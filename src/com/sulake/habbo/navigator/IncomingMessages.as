package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onRoomSettingsSaved(param1:IMessageEvent) : void
      {
         ...
         _navigator.mainViewCtrl.reloadRoomList(Tabs.const_206);
      }
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.reason)
         {
            case CantConnectMessageParser.const_1312:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1302:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.ROOMINFO));
            setToolbarExitIcon();
