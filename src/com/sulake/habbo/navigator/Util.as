package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1481:CutToHeight = new CutToHeight();
      
      private static var var_1480:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1481.beforeSearch(param2,param1,param3);
         binarySearch(var_1481,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1480.beforeSearch(param2,param1,param3);
         binarySearch(var_1480,param2.length - 1);
      }
   }
}
