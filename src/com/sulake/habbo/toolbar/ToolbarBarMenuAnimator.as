package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1115:Number = 90;
      ...
      private var var_999:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_475.push(param1.name);
         var_476.push(param2);
         param1.addEventListener(WindowEvent.const_431,windowEventListener);
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_999.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_302.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_302.splice(var_302.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_999.getIconLoc(param1.iconId);
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_302[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_771 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_771 || param1.desktop.height - param1.y < const_1071;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_475[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
