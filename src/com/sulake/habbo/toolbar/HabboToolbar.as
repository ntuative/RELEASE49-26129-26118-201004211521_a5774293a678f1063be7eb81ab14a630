package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_123,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_998,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_183,onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_469,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_714,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_904,onHideWindowEvent);
         var_32 = true;
