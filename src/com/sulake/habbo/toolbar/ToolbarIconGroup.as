package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_403:ToolbarBarMenuAnimator;
      ...
      {
         return var_1347.indexOf(param1) > -1;
      }
      ...
      public function getIconByMenuId(param1:String) : ToolbarIcon
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_324.length)
         {
            _loc2_ = var_324[_loc3_];
            if(_loc2_ != null)
            {
      ...
      private function alignItems() : void
      {
         ...
         {
            _loc2_ = var_761.indexOf(var_1349[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_324[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_778 + _loc3_);
                  _loc3_ += var_1348;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_403);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_324[var_761.indexOf(param1)];
      }
