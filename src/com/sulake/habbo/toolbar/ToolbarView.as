package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_200 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_60,HabboWindowStyle.const_867,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1061 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1061)
         {
            _window.addEventListener(WindowMouseEvent.const_52,method_6);
         ...
         var_1306 = _loc7_.toolbar.@margin_bottom;
         var_1542 = _loc7_.toolbar.@min_group_margin;
         var_1543 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_276,param1,param2,_window,var_259);
         createGroupsFromXmlList(_loc9_,var_614,param1,param2,var_200,var_259);
         alignWindows();
      }
      ...
      private function method_6(param1:WindowEvent) : void
      {
         if(var_1061)
         {
            var_1060 = true;
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_139,var_512,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1542,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1306) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1542,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1306) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_139,var_512);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_512);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_139,var_512);
         }
      }
