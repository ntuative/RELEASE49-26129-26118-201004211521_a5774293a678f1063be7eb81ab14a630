package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      {
         if(var_1187 == true || var_670 == 0)
         {
            if(false)
            {
               ++var_50;
               if(var_50 >= var_813.length)
               {
                  var_50 = 0;
                  ++var_670;
               }
      ...
      {
         return var_1187 == false && var_670 == 1 && var_1340 != var_32;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_50 <= var_814.length)
         {
            _loc2_ = var_814[var_50];
