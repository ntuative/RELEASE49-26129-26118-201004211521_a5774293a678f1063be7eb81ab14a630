package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_786:IRoomSession;
      ...
      private const const_1646:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionEvent.const_105,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_461,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_44.getValue(InventoryCategory.const_544));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_44.getValue(InventoryCategory.const_76));
      }
      ...
      {
         var_106.clubPeriods = param1;
         var_106.clubDays = param2;
         var_106.clubHasEverBeenMember = param3;
         var_106.isVIP = param4;
      ...
      {
         return PetsModel(var_44.getValue(InventoryCategory.const_143));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_866));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1646);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_44.getValue(InventoryCategory.const_324));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_787.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_787.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_44.getValue(InventorySubCategory.const_276));
      }
      ...
      {
         return var_106.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_44.getValue(InventoryCategory.const_294) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_971 = new IncomingMessages(this);
      ...
      {
         return var_106.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_106.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_44.getValue(InventoryCategory.const_270));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_105,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_461,roomSessionEventHandler);
         ...
         var_44.add(InventoryCategory.const_294,_loc3_);
         ...
         var_44.add(InventoryCategory.const_143,_loc10_);
