package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_228,onObjectPlaced);
         var_482 = new Timer(const_1082,1);
         var_482.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_47.getSubCategoryViewId() == InventorySubCategory.const_276;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_409.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_409.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_228,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_482 != null)
            {
               var_482.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_482.stop();
               var_482 = null;
            }
            if(var_127 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_331)
         {
         ...
         if(var_696 == null)
         {
            var_696 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_696.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_276:
               ...
               break;
            case InventorySubCategory.const_850:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_47.checkCategoryInitilization(InventoryCategory.const_294);
         ...
         if(param1 == InventoryCategory.const_76 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_304:
                  var_47.toggleInventoryPage(InventoryCategory.const_143);
            }
         }
      }
      ...
      {
         if(var_843 && param1.type == RoomEngineObjectEvent.const_228)
         {
            var_47.showView();
            var_843 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_331 || _loc3_.category == FurniCategory.const_312 || _loc3_.category == FurniCategory.const_306)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_409.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_409 = new Map();
         var_409.add(const_45,new Array());
         var_409.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
