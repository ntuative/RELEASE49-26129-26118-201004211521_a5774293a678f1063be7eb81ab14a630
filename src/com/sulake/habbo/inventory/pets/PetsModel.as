package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_143 && false)
         {
      ...
      private function method_3(param1:int) : PetData
      {
         var _loc2_:* = null;
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1231 && param1.type == RoomEngineObjectEvent.const_228)
         {
            var_47.showView();
            var_1231 = false;
         }
      ...
      {
         var _loc3_:PetData = method_3(param1);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         {
            var_1231 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_39,RoomObjectTypeEnum.const_302,_loc3_.figure);
            var_47.closeView();
            return;
         }
      ...
      {
         if(var_1018.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
