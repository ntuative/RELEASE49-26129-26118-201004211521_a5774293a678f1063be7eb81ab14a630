package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_487 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_600 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_600.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_311 != null)
         {
            var_311.setSelected(false);
         }
         var_311 = param1;
         if(var_311 != null)
         {
            var_311.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_311.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_600.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_487.removeGridItem(_loc2_.window);
         if(var_311 == _loc2_)
         {
            var_311 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_600.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_487.addGridItem(_loc2_.window);
            var_600.add(param1.id,_loc2_);
            if(var_311 == null)
            {
               selectFirst();
            }
