package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1654:int = 13421772;
      ...
      protected var var_2294:BitmapData;
      ...
      protected var var_456:int = 0;
      
      protected var var_1396:String;
      
      private const const_1655:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_380:BitmapData;
      
      private const const_1439:Number = 0.2;
      
      protected var var_1397:Boolean;
      
      private const const_1438:Number = 1;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1495));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1439;
               _loc1_.blend = const_1439;
            }
            else
            {
