package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_962:IItemGridWindow;
      ...
      private var var_961:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_961 = _view.findChildByName("inactive_items") as IItemGridWindow;
         var_961.procedure = inactiveGridEventProc;
         var_962 = _view.findChildByName("active_items") as IItemGridWindow;
         var_962.procedure = activeGridEventProc;
      }
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_962.getGridItemIndex(param1.window);
      ...
      private function updateActionView() : void
      {
         ...
         else
         {
            if(_loc2_.isInUse)
            {
               ...
               method_2("${badge_name_" + _loc2_.type + "}");
      ...
      private function updateListViews() : void
      {
         ...
         var_961.removeGridItems();
         var_962.removeGridItems();
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               var_961.addGridItem(_loc2_.window);
         ...
         while(_loc3_ < _loc4_.length)
         {
            ...
            var_962.addGridItem(_loc2_.window);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_961.getGridItemIndex(param1.window);
