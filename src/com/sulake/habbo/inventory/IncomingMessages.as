package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      {
         var _loc2_:* = null;
         if(var_10.isInventoryCategoryInit(InventoryCategory.const_294))
         {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_143);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_10.setInventoryCategoryInit(InventoryCategory.const_324);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_10.toggleInventorySubPage(InventorySubCategory.const_276);
         ...
         var _loc13_:TradingModel = var_10.tradingModel;
         if(_loc13_)
         {
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_294);
         var _loc4_:FurniModel = var_10.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
