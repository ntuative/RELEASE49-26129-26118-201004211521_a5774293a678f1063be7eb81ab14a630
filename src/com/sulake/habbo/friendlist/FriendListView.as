package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private var var_1291:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1291 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_795 = IWindowContainer(var_13.content.findChildByName("main_content"));
         var_287 = IWindowContainer(var_13.content.findChildByName("footer"));
         var_1291.prepare(var_795);
         var_13.procedure = onWindow;
         var_13.content.setParamFlag(HabboWindowParam.const_844,false);
         var_13.content.setParamFlag(HabboWindowParam.const_1271,true);
         var_13.header.setParamFlag(HabboWindowParam.const_537,false);
         var_13.header.setParamFlag(HabboWindowParam.const_994,true);
         var_13.content.setParamFlag(HabboWindowParam.const_537,false);
         var_13.content.setParamFlag(HabboWindowParam.const_994,true);
         var_13.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1290 = ITextWindow(var_13.findChildByName("info_text"));
         var_1290.text = "";
      ...
      public function openFriendList() : void
      {
         ...
         {
            prepare();
            _friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.FRIENDLIST,var_13));
         }
         else
         {
            var_13.visible = true;
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_287.y = Util.getLowestPoint(var_13.content);
         ...
         var_13.scaler.setParamFlag(HabboWindowParam.const_1027,this._friendList.tabs.findSelectedTab() != null);
         var_13.scaler.setParamFlag(HabboWindowParam.const_537,false);
         var_13.scaler.setParamFlag(HabboWindowParam.const_844,false);
         var_13.scaler.x = 0 - var_13.scaler.width;
         var_13.scaler.y = 0 - var_13.scaler.height;
         var_1532 = var_13.height;
         var_1531 = var_13.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1532 == -1 ? 0 : int(0 - var_1532);
         var _loc4_:int = var_1531 == -1 ? 0 : int(0 - var_1531);
