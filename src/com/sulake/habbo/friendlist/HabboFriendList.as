package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_177:String = "face";
      ...
      private var var_1575:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_626:ISessionDataManager;
      
      private var var_362:FriendRequests;
      
      private var var_2049:int;
      
      var var_87:FriendCategories;
      
      private var var_2189:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_914:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2189 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_87 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1575 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_362.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_362.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_405.findTab(FriendListTab.const_87).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_626 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_362 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_87.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_87.addCategory(new FriendCategory(FriendCategory.const_803,getText("friendlist.friends")));
         var_87.addCategory(new FriendCategory(FriendCategory.const_485,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_87.addFriend(new Friend(_loc4_));
         }
         var_405 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_534)
         {
            var_534 = new Timer(120000);
            var_534.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_534.start();
         }
         getBuddyRequests();
         registerListeners();
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_534.stop();
            var_534.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_534 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_793)
         {
            var_793.release(new IIDAvatarRenderManager());
            var_793 = null;
         }
         if(var_914)
         {
            var_914.release(new IIDHabboNotifications());
            var_914 = null;
         }
         if(var_190)
         {
         ...
         if(var_626)
         {
            var_626.release(new IIDSessionDataManager());
            var_626 = null;
         }
         super.dispose();
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_93);
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_405.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_341));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1575.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_362.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_626.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_626.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_362.limit)
         {
            var_362.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_405.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_793.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_362.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_405.findTab(FriendListTab.const_87);
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1574 == null)
         {
            var_1574 = new OpenedToWebPopup(this);
         }
         var_1574.show(x,y);
      }
