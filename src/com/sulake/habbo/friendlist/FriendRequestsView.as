package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1429:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_323 && _loc4_.state != FriendRequest.const_329)
            {
      ...
      {
         var_1513 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1514 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1514.procedure = onDismissAllButtonClick;
         var_1513.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_827)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1513,_loc1_);
         setEnabled(var_1514,_loc1_);
      }
