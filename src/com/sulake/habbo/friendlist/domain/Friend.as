package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1603:int = "F".charCodeAt(0);
      
      public static const const_1480:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_604 = param1.gender;
         var_681 = param1.online;
         var_1180 = param1.followingAllowed && param1.online;
         var_319 = param1.figure;
         var_1181 = param1.motto;
         var_1183 = param1.lastAccess;
         var_1182 = param1.categoryId;
         var_1184 = param1.realName;
