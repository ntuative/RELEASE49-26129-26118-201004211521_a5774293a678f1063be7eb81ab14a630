package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_291:int = 100;
      ...
      {
         return Math.ceil(this.var_244.length / const_291);
      }
      ...
      {
         if(this.var_939 >= this.getPageCount())
         {
            this.var_939 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_244[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_244.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_939 + 1) * const_291,this.var_244.length);
      }
