   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_468,0,0,_loc4_,var_1573,var_911,var_910));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2176 = int(_config.getKey("interstitial.interval","30000"));
         var_2175 = int(_config.getKey("interstitial.show.time","5000"));
         var_1571 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1326 = _loc2_.imageUrl;
         var_1573 = _loc2_.clickUrl;
         if(var_1326 != "" && var_1573 != "")
         {
            _loc3_ = var_1326;
            ...
            _loc4_ = new URLRequest(var_1326);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1327 = _loc2_.imageUrl;
         var_2174 = _loc2_.clickUrl;
         var_750 = getTimer();
         if(var_1327 != "")
         {
            _loc3_ = var_1327;
            ...
            if(var_235 == null)
            {
               var_235 = new Timer(var_2175,1);
               var_235.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_235.reset();
            ...
            var_235.start();
            _loc4_ = new URLRequest(var_1327);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_414,0,0,param1.bitmapData,var_2174));
            var_750 = getTimer();
         }
         else
         {
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1571 > 0 && var_1572 >= var_1571)
         {
            return false;
         }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_911 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
