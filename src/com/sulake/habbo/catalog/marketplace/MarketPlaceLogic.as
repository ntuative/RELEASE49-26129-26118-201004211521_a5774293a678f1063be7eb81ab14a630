package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2144:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1510,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1958 || param1.furniTypeId != var_1957)
         {
            return;
         }
         var_2144 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_202.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_202.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_202.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_393)
            {
               var_202.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_2099 = _loc3_.creditsWaiting;
         var_202 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_202.add(_loc4_.offerId,_loc6_);
         }
      ...
      {
         requestOffers(var_2142,var_2143,var_2034,var_2145);
      }
