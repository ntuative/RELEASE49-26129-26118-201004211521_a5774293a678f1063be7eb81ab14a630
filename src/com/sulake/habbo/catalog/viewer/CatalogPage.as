package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1186:EventDispatcher;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1385 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1385) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_810);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1147) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1173) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1186;
            _loc2_.init();
         }
         var_1186.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1186.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_810);
      }
