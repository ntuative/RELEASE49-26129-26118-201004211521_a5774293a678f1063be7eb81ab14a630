package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_662.length)
         {
            createLevelItem(var_662[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_662 = recycler.getPrizeTable();
         if(var_662 == null)
         {
            return;
         }
         ...
         var_1159 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_662[0].prizes.length > 0)
         {
            select(var_662[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1159) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1158) as IWindowContainer;
