package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1344 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_311 = null;
         for each(_loc1_ in var_1345)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1344) as IWindowContainer;
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_824.width,var_824.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var_824 = _loc3_.content as BitmapData;
