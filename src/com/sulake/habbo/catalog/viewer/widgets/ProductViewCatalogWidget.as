package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1471:Point;
      
      private var var_1874:Array;
      
      private var var_585:IItemGridWindow;
      
      private var var_83:IBitmapWrapperWindow;
      
      private var var_1272:ITextWindow;
      
      private var var_1212:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_585 != null)
         {
            var_585.visible = false;
            var_585.destroyGridItems();
         }
         if(var_1212 != null)
         {
            var_1212.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1272.text = "${" + _loc3_.name + "}";
            var_1273.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1272.text = "${" + _loc2_.localizationId + "}";
            var_1273.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_444:
                  ...
                  if(var_585 != null)
                  {
                     var_585.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_585,var_1212,var_1158);
                  }
                  break;
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_225:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_51,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_319,AvatarAction.const_667);
                              _loc13_.appendAction(AvatarAction.const_531,_loc6_.productClassId);
      ...
      {
         var_1272 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1273 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1471 = new Point(var_83.x,var_83.y);
         var_585 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1212 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_585 == null)
         {
         ...
         var_1213 = _loc2_.content as BitmapData;
