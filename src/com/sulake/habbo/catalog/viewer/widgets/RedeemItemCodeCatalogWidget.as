package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1105:IButtonWindow;
      
      private var var_1104:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1105 != null)
         {
            var_1105.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1104 != null)
         {
            var_1104.removeEventListener(WindowKeyboardEvent.const_141,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1105 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1105 != null)
         {
            var_1105.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1104 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1104 != null)
         {
            var_1104.addEventListener(WindowKeyboardEvent.const_141,windowKeyEventProcessor);
         }
      }
