package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1083 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1083 != null)
         {
            var_1083.addEventListener(WindowKeyboardEvent.const_688,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1083.text));
      }
   }
}
