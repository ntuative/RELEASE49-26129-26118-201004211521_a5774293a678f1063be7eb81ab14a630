package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_906:MarketPlaceOfferData;
      
      private const const_1436:int = 1;
      
      private const const_1662:int = 40;
      ...
      private const const_1661:int = 10;
      ...
      private function updateList() : void
      {
         ...
         updateStatusDisplay(const_1437,_loc2_.length);
         if(!var_440)
         {
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_905 >= var_567.length)
            {
               return true;
            }
            addListItem(var_567.getWithIndex(var_905));
            ++var_905;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_906.offerId);
            }
            return;
         }
