package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_621[var_1075] as Array;
      ...
      {
         var _loc2_:Offer = var_621[var_1075][var_2173];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_371 || _loc1_.pricingModel == Offer.const_416)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_85 || _loc3_.productType == ProductTypeEnum.const_84)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1076.indexOf(_loc5_) == -1)
                        {
                           var_1076.push(_loc5_);
                           var_621.push(new Array());
                        }
                        _loc6_ = var_1076.indexOf(_loc5_);
                        (var_621[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_621)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_621)
         {
            if(var_2173 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2173] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1075 = var_956.getGridItemIndex(param1.view);
