package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_385:ClubBuyController;
      ...
      private var var_293:CatalogViewer;
      ...
      private var var_1645:GiftWrappingConfiguration;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_106.credits = _loc3_.balance;
         updatePurse();
         if(!var_1646 && var_461 != null)
         {
            var_461.playSound(HabboSoundTypesEnum.const_808);
         }
         var_1646 = false;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_385 == null)
         {
            var_385 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_99:
               var_1130 = param1.session.isPrivateRoom;
               if(var_81 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1645 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_968.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_106.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_106.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_106.isVIP = _loc2_.isVIP;
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_968 == null)
         {
            var_968 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         {
            var_385.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      {
         if(param1 == null || var_293 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_293.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_106.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_106.pixels));
         var _loc1_:int = 0;
         if(true)
         {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_106.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_106.clubPeriods));
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_293.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_106.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1644 && var_461 != null)
         {
            var_461.playSound(HabboSoundTypesEnum.const_837);
         }
         var_1644 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_293.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_293.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_293 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_293.habboCatalog = this;
      }
