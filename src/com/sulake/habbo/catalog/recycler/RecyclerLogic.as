package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_792:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1581)
         {
            case RecyclerStatusMessageEvent.const_1224:
               var_281 = const_355;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_960:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1581 != RecyclerStatusMessageEvent.const_960;
      }
      
      private function get statusActive() : Boolean
      {
         return var_281 != const_792;
      }
      ...
      {
         return active && var_281 == const_355;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_881:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1237:
