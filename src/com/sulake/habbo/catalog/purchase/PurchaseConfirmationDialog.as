package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1419:uint = 4.294967295E9;
      
      private const const_1420:uint = 4.293848814E9;
      
      private var var_852:int;
      
      private const const_1656:uint = 4.291613146E9;
      
      private var var_266:int = -1;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_851;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_851,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1420) : uint(const_1419);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_398,var_76,var_1024);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_266) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_851);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_593[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_594[var_195]);
         _catalog.purchaseProductAsGift(var_398,var_76,var_1024,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_115:
               ...
               if(var_1950 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_244)
               {
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_85:
                  ...
                  break;
               case ProductTypeEnum.const_225:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1490 = _loc1_.stuffTypes;
            var_593 = _loc1_.boxTypes;
            var_594 = _loc1_.ribbonTypes;
            var_851 = var_1490[0];
            _boxIndex = var_593[0];
            var_195 = var_594[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_266) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_266);
         }
         var_266 = param1;
         if(var_266 < 0)
         {
            var_266 = _loc2_.numListItems - 1;
         }
         if(var_266 >= _loc2_.numListItems)
         {
            var_266 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_266) as IWindowContainer;
