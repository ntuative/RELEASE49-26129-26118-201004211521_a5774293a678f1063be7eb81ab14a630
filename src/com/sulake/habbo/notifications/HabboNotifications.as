package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1076:String = "badges";
      
      private static const const_1075:String = "pet_inventory";
      
      private static const const_1077:String = "pixelbalance";
      
      private static const const_1073:String = "credits";
      
      private static const const_1078:String = "inventory";
      
      private static const const_1072:String = "friendlist";
      
      private static const const_1079:String = "selectfurni";
      ...
      private var var_577:ParkBusDialogManager;
      
      private var var_578:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_404:HabboNotificationViewManager;
      
      private var var_683:ClubEndingNotification;
      ...
      private var var_682:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_829);
         }
         var _loc6_:Map = var_829["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1191);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_682 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_881)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1377);
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_578)
         {
            var_578.release(new IIDHabboToolbar());
            var_578 = null;
         }
         if(_windowManager)
         {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_85:
               ...
               break;
            case CatalogPageMessageProductData.const_225:
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1179);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1839)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_825);
            var_1839 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1075:
               if(var_10)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_143);
               }
               break;
            case const_1079:
               break;
      ...
      {
         if(param1 != null && this.var_404 != null)
         {
            var_404.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_825,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = _avatarRenderManager.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_41,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_51);
         _loc4_.dispose();
         if(_loc3_)
         {
      ...
      {
         if(param2.type == WindowEvent.const_175 || param2.type == WindowEvent.const_512)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_404.isSpaceAvailable() && false)
         {
            var_404.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_577 == null)
         {
            var_577 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_577 != null)
         {
            var_577.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1008.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = _avatarRenderManager.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = _avatarRenderManager.createAvatarImage(param2,AvatarScaleType.const_56);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1209)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_683 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      {
         var_578 = IHabboToolbar(param2);
         var_578.events.addEventListener(HabboToolbarEvent.const_86,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_343.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_930);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_930);
            }
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_331;
            }
            if(param2 == 4057)
            {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_86)
         {
            ...
            var_404 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_829["styles"],var_829["view"],var_578);
            ...
            registerUpdateReceiver(var_404,1);
            registerUpdateReceiver(this,2);
            var_343.events.addEventListener(BadgeImageReadyEvent.const_109,onBadgeImage);
            var_578.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
