package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_402:Sprite = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_101,onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_101,onShowLoadingBar);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_265,onHideLoadingBar);
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_402 = new Sprite();
            var_402.addChild(new Bitmap(_image));
            var_402.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_402.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_402);
         _window.visible = true;
         _window.center();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_101,onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_101,onShowLoadingBar);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_265,onHideLoadingBar);
      }
      
      private function onHideLoadingBar(param1:RoomWidgetLoadingBarUpdateEvent) : void
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_265)
         {
            return;
         }
         if(_window != null)
      ...
      override public function dispose() : void
      {
         if(var_402 != null)
         {
            var_402.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_402 = null;
         }
         if(_image != null)
         {
