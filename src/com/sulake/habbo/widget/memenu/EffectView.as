   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_892 = _window.findChildByName("effect_hilite");
            var_892.visible = false;
         }
         var_891 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_893 = _window.findChildByName("loader_bar");
         if(var_893 != null)
         {
            var_426 = var_893.width;
            var_181.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_891 != null)
         {
            var_891.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_891.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
