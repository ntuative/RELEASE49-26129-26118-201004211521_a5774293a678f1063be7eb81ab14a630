package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_515:DimmerViewColorGrid;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_218.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_218.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_60,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1066,const_1065,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_515 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         ...
         var_218 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_218.numTabItems)
         {
            _loc6_ = var_218.getTabItemAt(_loc2_);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_515 != null)
         {
            var_515.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_218.selector.getSelected();
         return var_218.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1067 = _loc2_.light;
         if(var_357 != null)
         {
            var_357.setValue(var_1067);
         }
         var_436 = colors.indexOf(_loc2_.color);
         if(var_515 != null)
         {
            var_515.setSelectedColorIndex(var_436);
         }
