package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var_50 = (_doorbell.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_50 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         var_48 = var_50.findChildByName("user_list") as IItemListWindow;
         var_50.visible = false;
         var _loc2_:IWindow = var_50.findChildByTag("close");
         if(_loc2_ != null)
         {
