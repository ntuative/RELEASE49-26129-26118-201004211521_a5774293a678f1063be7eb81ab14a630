package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1121:InfoStandPetData;
      
      private var var_126:Timer;
      
      private var var_833:InfoStandFurniView;
      
      private var var_409:InfostandFurniData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_833 = new InfoStandFurniView(this,const_1423);
         var_192 = new InfoStandUserView(this,const_1422);
         var_303 = new InfoStandPetView(this,const_1424);
         var_344 = new InfoStandBotView(this,const_1421);
         var_413 = new InfostandUserData();
         var_409 = new InfostandFurniData();
         var_1121 = new InfoStandPetData();
         var_126 = new Timer(const_1652);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_192.setTags(param1.tags,var_1853);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_235,onClose);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_426,var_303.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_235,onClose);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_60,HabboWindowStyle.const_43,HabboWindowParam.const_43,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_253:
               ...
               {
                  _loc2_ = param1.id == var_1121.roomIndex;
                  break;
               }
