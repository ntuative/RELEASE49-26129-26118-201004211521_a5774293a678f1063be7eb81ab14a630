package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1639:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1638:String = "level";
      
      private var var_99:IItemListWindow;
      
      private const const_1637:String = "energy";
      
      private var var_1121:Map;
      
      private const const_1640:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1636:uint = 3355443;
      ...
      private var var_164:PetCommandTool;
      
      private const const_1634:uint = 11184810;
      
      private const const_1635:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_230 != null)
         {
            var_99 = var_230.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_99.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_99.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(var_99 == null || var_230 == null || var_60 == null)
         {
            return;
         }
         var_60.width = var_60.scrollableRegion.width;
         var_60.visible = false;
         var_99.height = var_99.scrollableRegion.height;
         var_230.height = NaN;
         _window.width = Math.max(var_230.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         if(var_164 == null)
         {
            var_164 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1121.getValue(var_586) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_164.showWindow(true);
            var_164.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set name(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_99.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_99.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_99.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1635,param1.experience,param1.experienceMax);
         updateStateElement(const_1637,param1.energy,param1.energyMax);
         updateStateElement(const_1640,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_586 = param1.id;
         var_1121.remove(param1.id);
         var_1121.add(param1.id,param1);
         if(var_164 && var_164.isVisible() && param1.isOwnPet)
         {
            var_164.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_99.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_164.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_164 && var_164.getPetId() == var_586)
               {
                  var_164.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_467,_widget.petData.ownerId);
