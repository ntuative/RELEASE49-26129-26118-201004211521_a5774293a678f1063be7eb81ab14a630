package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1663:int = 5;
      
      private const const_1664:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1324 != null && var_1324.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_909 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_909 += param1.height + const_1664;
            return fit(param1);
         }
         param1.offset(_offsetX,var_909);
         _offsetX += param1.width + const_1663;
         return true;
      }
