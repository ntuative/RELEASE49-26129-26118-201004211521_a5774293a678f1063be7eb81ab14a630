package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1428:int = 5;
      
      private static const const_489:int = 16;
      
      private static const const_1099:int = 20;
      ...
      private var var_426:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_2019 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2017 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_713 = new Timer(1000,1);
         var_713.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_871 = new Timer(5000,1);
         var_871.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_60,HabboWindowStyle.const_43,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowEvent.const_115,onInputChanged);
         _window.addEventListener(WindowEvent.const_431,onWindowMoved);
         var_1264 = true;
         var_133 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2018 = _loc2_.width + const_489 + _loc6_.width + const_1099;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1098,_loc8_.width) + const_489);
            _loc8_.x = _loc12_;
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_426);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_426);
         }
