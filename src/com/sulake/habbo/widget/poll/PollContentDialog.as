package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_652[var_966] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_292)
         {
            ...
            var_292 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_292.center();
            var_292.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_966;
         if(var_966 < var_652.length)
         {
            _loc1_ = var_652[var_966] as Dictionary;
            if(!_loc1_)
            {
