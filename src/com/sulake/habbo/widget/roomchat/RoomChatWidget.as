package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_786:int = 10;
      
      private static const const_499:int = 25;
      
      private static const const_1114:int = 6000;
      
      private static const const_1113:int = 9;
      
      private static const const_785:int = 4000;
      ...
      private static const const_500:int = (const_501 + const_351) * const_102 + const_102;
       
      
      private var var_890:Number = 1;
      
      private var _disposed:Boolean = false;
      
      private var var_609:int = 18;
      ...
      private var var_2109:int = 150;
      
      private var var_501:Number = 1;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_231 = new Array();
         var_738 = new Point();
         var_154 = const_500 + const_282;
         super(param1,param2,param3);
         var_2111 = param5;
         var_37 = param1.createWindow("chat_container","",HabboWindowType.const_60,HabboWindowStyle.const_42,HabboWindowParam.const_43,new Rectangle(0,0,200,var_154 + RoomChatHistoryPulldown.const_78),null,0) as IWindowContainer;
         var_37.background = true;
         var_37.color = 33554431;
         var_37.tags.push("room_widget_chat");
         var_354 = param1.createWindow("chat_contentlist","",HabboWindowType.const_841,HabboWindowStyle.const_43,0 | 0,new Rectangle(0,0,200,var_154),null,0) as IItemListWindow;
         var_37.addChild(var_354);
         var_137 = param1.createWindow("chat_active_content","",HabboWindowType.const_60,HabboWindowStyle.const_43,HabboWindowParam.const_75,new Rectangle(0,0,200,var_154),null,0) as IWindowContainer;
         var_354.addListItem(var_137);
         var_26 = new RoomChatHistoryViewer(this,param1,var_37,param2);
         var_2109 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_653,onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_248,onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_574,onRoomViewUpdate);
      ...
      public function resetArea() : void
      {
         ...
         animationStop();
         var_154 = const_500 + const_282;
         var_37.height = var_154 + var_26.pulldownBarHeight;
         var_354.width = 0 - 0;
         var_354.height = var_154;
         var_137.width = 0 - 0;
      ...
      private function processBuffer() : void
      {
         ...
         while(var_65.length > const_1112 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_736 = getTimer() + const_785;
         }
         else
         {
            if(false && false)
            {
               var_609 = getItemSpacing(_itemList["-1"],var_65[0]);
            }
            else
            {
               var_609 = const_102;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_738.x) * var_890;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = 0 - const_786;
         var _loc6_:Number = 0 + const_786 - 0;
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1298 && !historyViewerActive())
         {
            resetArea();
            var_1298 = false;
         }
      ...
      {
         return "chat_" + var_2111.toString() + "_item_" + (var_2110++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_653,onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_248,onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_574,onRoomViewUpdate);
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!historyViewerActive() ? 0 : Number(var_501);
            if(_loc2_ == -1)
            {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_442)
         {
            _loc2_ = param1 / const_1070 * const_1115;
            if(_loc2_ + var_737 > var_609)
            {
               _loc2_ = var_609 - var_737;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            ...
            {
               var_890 = param1.scale / var_1536;
            }
         }
         if(param1.positionDelta != null)
         {
            var_738.x += param1.positionDelta.x / var_890;
            var_738.y += param1.positionDelta.y / var_890;
         }
         if(param1.rect != null)
         {
            if(var_26 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_2109)
         {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(false)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(var_501,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = var_501;
               if(_loc1_.aboveLevels > const_501 + const_351 + 2)
               {
                  _loc1_.aboveLevels = const_501 + const_351 + 2;
               }
               var_501 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_154 = param1 - 0;
         var_37.height = var_154 + RoomChatHistoryPulldown.const_78;
         if(var_26 != null)
         {
            var_26.containerResized(var_37.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_590,param1,param2,param4,param5);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_351 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1114)
               {
