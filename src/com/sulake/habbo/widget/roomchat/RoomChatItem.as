package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1040:Number = 18;
      
      private static const const_1412:Number = 10;
      
      private static const const_1413:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_959,var_958,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_959,var_650,var_958,_roomId,_roomCategory,param1);
      }
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         var_959 = param1.userId;
         var_650 = param1.userName;
         var_958 = param1.userCategory;
         _message = param1.text;
         var_1123 = param1.userX;
         var_186 = param1.userImage;
         var_960 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_79,_y,width,_height);
      ...
      public function renderView() : void
      {
         ...
         switch(var_1125)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_249:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_258:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_186 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_384 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_960 != 0)
            {
               _loc30_ = uint(var_960 >> 16 & 255);
               _loc31_ = uint(var_960 >> 8 & 255);
               _loc32_ = uint(var_960 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1125 == RoomWidgetChatUpdateEvent.const_249)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_650);
            }
            else if(var_1125 == RoomWidgetChatUpdateEvent.const_258)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_650);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_346 + _loc20_.textWidth + const_489;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_959,var_958,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_959,var_958,_roomId,_roomCategory,param1);
      }
