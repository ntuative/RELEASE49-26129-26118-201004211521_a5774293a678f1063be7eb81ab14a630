package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1554 = getTimer();
         var_524.add(var_1315,var_1554);
         _connection.send(new LatencyPingRequestMessageComposer(var_1315));
         ++var_1315;
      }
      ...
      public function init() : void
      {
         ...
         var_1556 = int(var_147.getKey("latencytest.interval"));
         var_1557 = int(var_147.getKey("latencytest.report.index"));
         var_2155 = int(var_147.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var_157.push(_loc4_);
         if(var_157.length == var_1557 && var_1557 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1555) > var_2155 || var_1555 == 0)
            {
               var_1555 = _loc9_;
