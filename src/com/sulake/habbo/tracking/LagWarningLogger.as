package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1248 || var_1515 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1516 == 0 || _loc1_ - var_1516 > var_1515)
         {
            if(_connection != null)
            {
      ...
      {
         var_1248 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1515 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
