package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_752:uint = 11;
       
      
      private var var_216:LatencyTracker = null;
      
      private var var_215:PerformanceTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_215 = new PerformanceTracker();
         var_216 = new LatencyTracker();
         var_780 = new LagWarningLogger();
         var_1126 = new Array(const_752);
         var _loc4_:int = 0;
         while(_loc4_ < const_752)
         {
            var_1126[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1293,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1286,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_606,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_855,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1249);
               break;
            ...
            case HabboCommunicationEvent.const_203:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_203);
               if(var_216 != null)
               {
                  var_216.init();
               }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_341:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_147)
         {
            Component(var_147).events.addEventListener(HabboConfigurationEvent.const_168,onConfigurationLoaded);
            if(var_216 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_277.events.addEventListener(AdEvent.const_468,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1625)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1222);
            var_1625 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_855,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_606,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_687,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_203,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_721,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_70,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_451,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_374:
         ...
         if(!disposed)
         {
            ...
            if(var_167)
            {
               if(true)
               {
                  ...
                  Component(var_167).events.removeEventListener(HabboFriendListTrackingEvent.const_341,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_374,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_147)
         {
            if(var_780 != null)
            {
               var_780.configure(var_147);
            }
            Component(var_147).events.removeEventListener(HabboConfigurationEvent.const_168,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_863);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_863,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_963 > -1 && _loc2_ < var_963)
         {
            ++var_1400;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1400);
         }
         if(var_963 > -1 && _loc2_ - var_963 > 15000)
         {
            ++var_1401;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1401);
         }
         var_963 = _loc2_;
         if(var_215 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_374,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_261,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_167).events.addEventListener(HabboFriendListTrackingEvent.const_341,onFriendlistTrackingEvent);
      }
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_147)
            {
               if(var_147.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_215 != null)
                  {
                     _loc4_["null"] = var_215.flashVersion;
                     _loc4_["null"] = var_215.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_721)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1228);
         }
         else if(param1.type == HabboHotelViewEvent.const_451)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1161);
         }
