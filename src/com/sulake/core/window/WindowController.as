package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_16)
         {
            var_16 = getGraphicContext(!testParamFlag(WindowParam.const_35));
         }
         ...
         if(_loc13_)
         {
            var_394 = _loc13_.blend;
            var_545 = _loc13_.treshold;
            if(var_637 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_544 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
         ...
         if(param7 != null)
         {
            ...
            if(var_16)
            {
               var_15.invalidate(this,var_7,WindowRedrawFlag.const_79);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_124,WindowParam.const_144);
         var _loc2_:* = !testParamFlag(WindowParam.const_128,WindowParam.const_145);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_239)
               {
                  _loc3_.width += _loc4_;
               }
               ...
               {
                  if(var_8.width < _loc3_.width && getParamFlag(WindowParam.const_35))
                  {
                     _loc3_.x = 0;
                  }
                  else
            ...
            if(_loc2_)
            {
               ...
               {
                  if(var_8.height < _loc3_.height && getParamFlag(WindowParam.const_35))
                  {
                     _loc3_.y = 0;
                  }
                  else
      ...
      {
         var_637 = param1;
         var_544 = !!var_637 ? uint(var_544 | var_1382) : uint(var_544 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2213 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_990:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1308:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1268:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_548:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_744:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_920:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_533:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_78 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_453,this,null));
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_576,var_7);
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_15.invalidate(this,var_7,WindowRedrawFlag.const_947);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1088 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         return !testParamFlag(WindowParam.const_35) || var_16 != null;
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_544 = !!var_637 ? uint(param1) : uint(param1 & 16777215);
         var_15.invalidate(this,var_7,WindowRedrawFlag.const_79);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_707))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1020;
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_245))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_245))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_165:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_413,this,null));
                     if(testParamFlag(WindowParam.const_156,WindowParam.const_144))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_173,WindowParam.const_145))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_380:
                  var_15.invalidate(this,var_7.union(var_55),WindowRedrawFlag.const_366);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_961,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_247,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_336:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_578,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_222,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_483:
                  var_15.invalidate(this,var_7,WindowRedrawFlag.const_932);
                  break;
               case WindowNotifyEvent.const_453:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_421:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_15.invalidate(this,var_7,WindowRedrawFlag.const_366);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_222:
                  ...
                  break;
               case WindowNotifyEvent.const_413:
                  var_8.getRegionProperties(null,var_323);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_342:
      ...
      {
         return var_642 != null ? var_642 : (var_8 != null ? var_8.procedure : nullEventProc);
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_958,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_336;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_644,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_720;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1088 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      {
         return !testParamFlag(WindowParam.const_35) ? getGraphicContext(true).fetchDrawBuffer() : (var_8 != null ? var_8.fetchDrawBuffer() : null);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_32 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_483,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_482)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_362)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_834,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_680,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_380,this,null));
            }
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_165,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1175,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_68,true);
         _loc1_.type = WindowNotifyEvent.const_1353;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_163 && var_545 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1585,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1585,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_15.invalidate(this,param1,WindowRedrawFlag.const_79);
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1325,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_68,false);
         _loc1_.type = WindowNotifyEvent.const_1347;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               var_323 = var_8.rectangle.clone();
               var_55.x = var_7.x;
               var_55.y = var_7.y;
               var_55.width = var_7.width;
               var_55.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_372,this,var_8));
            }
            else
            {
               var_323.x = 0;
               ...
               var_323.width = 0;
               var_323.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_858,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,_param,var_15,var_7,null,var_642,properties,var_638.concat(),_id) as WindowController;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_533;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_423;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_941,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         if(var_32 == WindowState.const_448)
         {
            return true;
         }
