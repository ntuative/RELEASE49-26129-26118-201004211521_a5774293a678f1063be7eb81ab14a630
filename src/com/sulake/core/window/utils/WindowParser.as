package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1488:String = "_INCLUDE";
      ...
      private static const const_1101:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1116:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_952:Dictionary;
      
      protected var var_1388:Map;
      
      protected var var_15:IWindowContext;
      
      protected var var_1389:Dictionary;
      
      protected var var_1117:Dictionary;
      
      public function WindowParser(param1:IWindowContext)
      {
         super();
         var_15 = param1;
         var_1117 = new Dictionary();
         var_1116 = new Dictionary();
         TypeCodeTable.fillTables(var_1117,var_1116);
         var_952 = new Dictionary();
         var_1389 = new Dictionary();
         ParamCodeTable.fillTables(var_952,var_1389);
         var_1388 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1101,"");
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1117)
            {
               delete var_1117[_loc1_];
            }
            for(_loc1_ in var_1116)
            {
               delete var_1116[_loc1_];
            }
            for(_loc1_ in var_952)
            {
               delete var_952[_loc1_];
            }
            for(_loc1_ in var_1389)
            {
               delete var_1389[_loc1_];
            }
            var_1388.dispose();
            var_1388 = null;
            var_15 = null;
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_156)
                     {
                        window.x = rect.x;
                     }
