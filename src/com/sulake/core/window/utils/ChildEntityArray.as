package com.sulake.core.window.utils
{
   public class ChildEntityArray extends ChildEntityArrayReader implements IChildEntityArray
   {
      ...
      {
         swapChildren(var_29[param1],var_29[param2]);
      }
      
      public function removeChild(param1:IChildEntity) : IChildEntity
      {
         var _loc2_:int = var_29.indexOf(param1);
         if(_loc2_ < 0)
         {
            return null;
         }
      ...
      public function swapChildren(param1:IChildEntity, param2:IChildEntity) : void
      {
         ...
         {
            _loc3_ = var_29.indexOf(param1);
            if(_loc3_ < 0)
            {
               return;
            }
            _loc4_ = var_29.indexOf(param2);
            if(_loc4_ < 0)
            {
               return;
            }
            ...
            var_29.splice(_loc4_,1);
            var_29.splice(_loc3_,1);
            var_29.splice(_loc3_,0,param2);
            var_29.splice(_loc4_,0,param1);
         }
      }
      
      public function removeChildAt(param1:int) : IChildEntity
      {
         var _loc2_:IChildEntity = var_29[param1];
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:int = var_29.indexOf(param1);
