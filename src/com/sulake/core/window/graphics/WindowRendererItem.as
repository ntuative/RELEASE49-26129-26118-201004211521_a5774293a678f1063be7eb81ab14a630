package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_800:uint = 1;
      
      private static const const_799:uint = 2;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_366:
               ...
               break;
            case WindowRedrawFlag.const_932:
               var_770 = var_740.getTheActualState(param1.type,param1.style,param1.state);
               if(var_770 != var_1106)
               {
                  var_243 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_947:
               if(param1.testParamFlag(WindowParam.const_35))
               {
                  var_243 = true;
                  _loc4_ = true;
      ...
      {
         return var_740.getTheActualState(param1.type,param1.style,param1.state) != var_1106;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc11_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_799) : uint(const_504);
         var _loc7_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(var_770))
            {
               _loc5_ = const_800;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_800)
               {
                  ...
                  if(var_243)
                  {
                     ...
                     _loc7_.draw(param1,var_92,var_92.rect,var_770,false);
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_810)
            {
               _loc2_ = var_740.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_810);
            }
         }
         return _loc2_;
      }
