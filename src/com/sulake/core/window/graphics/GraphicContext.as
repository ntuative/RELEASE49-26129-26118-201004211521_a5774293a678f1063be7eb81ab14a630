package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_938:uint = 256;
      
      protected static var var_647:uint = 0;
      
      protected static var var_382:uint = 0;
      
      public static const const_888:uint = 2;
      
      public static const const_1559:uint = 128;
      
      public static const const_1537:uint = 64;
      
      public static const const_605:uint = 4;
      
      public static const const_1254:uint = 0;
      
      public static const const_1238:uint = 16;
      
      public static const const_576:uint = 1;
      
      public static const const_1282:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_641:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1238:
               ...
               break;
            case GraphicContext.const_605:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_938:
               break;
            case GraphicContext.const_1254:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_641)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_382 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_641)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_382 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
