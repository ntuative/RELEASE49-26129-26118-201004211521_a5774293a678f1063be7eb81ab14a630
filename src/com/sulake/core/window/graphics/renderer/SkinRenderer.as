package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_328:Dictionary;
      
      protected var var_329:Dictionary;
      
      protected var var_453:Dictionary;
      
      public function SkinRenderer(param1:Array)
      {
         super();
         var_328 = new Dictionary();
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_329)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_329[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_328[param1.name];
         }
         return param1;
      }
      ...
      {
         var _loc3_:ISkinLayout = var_453[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_328[param2];
         if(_loc3_ == null)
         {
            throw new Error("Template \"" + param2 + "\" not found in renderer!");
         }
         var_329[param1] = _loc3_;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_453[_loc1_]).dispose();
         ...
         {
            ISkinTemplate(var_328[_loc1_]).dispose();
