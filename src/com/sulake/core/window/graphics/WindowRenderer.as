package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_316:Dictionary;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_610 = new Array();
         var_1541 = new Point();
         var_1540 = new Rectangle();
         var_315 = new Rectangle();
         var_316 = new Dictionary(true);
         var_740 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_316[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_610.pop() as WindowController;
            if(!_loc1_.disposed)
            {
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_692,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_316[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_610 = null;
            for(_loc1_ in var_316)
            {
               delete var_316[_loc1_];
            }
            var_316 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1541,var_1540))
            {
               if(param2.render(param1,var_1541,var_1540))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            var_316[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_692,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            getWindowRendererItem(param1).invalidate(param1,var_315,WindowRedrawFlag.const_256);
            if(var_610.indexOf(param1) == -1)
            {
               var_610.push(param1);
            }
         }
