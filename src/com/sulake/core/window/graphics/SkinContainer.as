package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      protected static var var_383:Array;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1535 = new Dictionary();
         var_2106 = new Dictionary();
         TypeCodeTable.fillTables(var_1535,var_2106);
         var_1294 = new Dictionary();
         var_2105 = new Dictionary();
         StateCodeTable.fillTables(var_1294,var_2105);
         ...
         {
            var_383 = new Array();
            var_383.push(WindowState.const_68);
            var_383.push(WindowState.const_74);
            var_383.push(WindowState.const_100);
            var_383.push(WindowState.WINDOW_STATE_SELECTED);
            var_383.push(WindowState.const_83);
            var_383.push(WindowState.const_77);
            var_383.push(WindowState.const_96);
            var_383.push(WindowState.const_89);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1294)
         {
            _loc3_.push(var_1294[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1535[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_731[param1];
      ...
      {
         var _loc3_:Array = var_732[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_732[param1] = new Array(SkinContainer.const_784);
         }
         var_732[param1][param2] = param3;
         if(true)
         {
            var_731[param1] = new Array(SkinContainer.const_784);
         }
         var_731[param1][param2] = param4;
      }
