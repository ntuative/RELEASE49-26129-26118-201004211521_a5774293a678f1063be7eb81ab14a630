package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1086:String = "_HEADER";
      
      private static const const_777:String = "margin_right";
      
      private static const const_1088:String = "_SCALER";
      
      private static const const_1087:String = "_TITLE";
      
      private static const const_1089:String = "_CONTENT";
      
      private static const const_776:String = "margin_left";
      
      private static const const_774:String = "margin_bottom";
      ...
      private var var_1230:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_776,_loc3_.left,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_775,_loc3_.top,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_777,0 - _loc3_.right,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_774,0 - _loc3_.bottom,PropertyStruct.const_65,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_245);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_202);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_234);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_202,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_202,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_234,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_234,false);
            }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1230 == null)
         {
            var_1230 = findChildByTag(const_1086) as IHeaderWindow;
            if(!var_1230)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1087) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1088) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_251,false);
         }
      ...
      {
         return content != null && var_1395 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_19 == null)
         {
            var_19 = findChildByTag(const_1089) as IWindowContainer;
            if(!var_19)
            {
