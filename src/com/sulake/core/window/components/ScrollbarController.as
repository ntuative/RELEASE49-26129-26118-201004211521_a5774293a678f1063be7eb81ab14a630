package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1081:String = "increment";
      
      private static const const_495:String = "slider_bar";
      
      private static const const_1080:String = "decrement";
      ...
      protected var var_773:Number = 0.1;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_495:
         ...
         if(param2.type == WindowNotifyEvent.const_372)
         {
            if(var_20 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_772) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_20 != null && true)
         {
            IWindow(var_20).removeEventListener(WindowEvent.const_48,onScrollableResized);
         }
         var_20 = param1;
         if(var_20 != null && true)
         {
            IWindow(var_20).addEventListener(WindowEvent.const_48,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_495) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_835 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_835 != null)
         {
            _loc1_ = findParentByName(var_835) as IScrollableWindow;
            if(_loc1_ == null && var_8 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_835) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1081)
            {
               if(var_20)
               {
                  var_584 = true;
            ...
            else if(param2.name == ScrollbarController.const_1080)
            {
               if(var_20)
               {
                  var_584 = true;
            ...
            else if(param2.name == ScrollbarController.const_772)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_495).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_893)
         {
