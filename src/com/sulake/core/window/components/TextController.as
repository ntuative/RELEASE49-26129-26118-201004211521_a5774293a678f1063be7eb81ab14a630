package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2355:Rectangle = new Rectangle();
      ...
      {
         return new Rectangle(var_639 * maxScrollH,var_378 * maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_854,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_363,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_363,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_700,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_700,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_left",var_66.left,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("margin_top",var_66.top,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("margin_right",var_66.right,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_66.bottom,PropertyStruct.const_65,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_700,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
