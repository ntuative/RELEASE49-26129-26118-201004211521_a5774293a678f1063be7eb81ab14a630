package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
      ...
      {
         var _loc3_:* = null;
         if(param2.type == WindowNotifyEvent.const_336)
         {
            if(var_8)
            {
               if(!(var_8 is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_222,this,null));
                        break;
                     }
      ...
      public function select() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_475,this,null);
         update(this,_loc1_);
      ...
      public function unselect() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_744;
         update(this,_loc1_);
         return true;
      }
   }
