package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_341:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_341)
         {
            var_341 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_341)
            {
               var_341.addEventListener(WindowEvent.const_262,scrollBarEventProc);
               var_341.addEventListener(WindowEvent.const_219,scrollBarEventProc);
            }
         }
         return var_341;
      }
      ...
      override public function dispose() : void
      {
         if(var_341)
         {
            var_341.removeEventListener(WindowEvent.const_262,scrollBarEventProc);
            var_341.removeEventListener(WindowEvent.const_219,scrollBarEventProc);
            var_341 = null;
         }
         if(var_805)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_805)
         {
            var_805 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_805;
      }
