package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected var var_1113:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_88 = 0;
         var_67 = 0;
         _horizontal = param2 == WindowType.const_340;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_163 = var_637 || !testParamFlag(WindowParam.const_35);
         _container = var_15.create("_CONTAINER","",WindowType.const_299,WindowStyle.const_288,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_48,containerEventHandler);
         _container.addEventListener(WindowEvent.const_440,containerEventHandler);
      ...
      {
         return new Rectangle(var_550 * maxScrollH,var_549 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_440,containerEventHandler);
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_550 = param1;
            _container.x = -var_550 * maxScrollH;
            var_15.invalidate(_container,visibleRegion,WindowRedrawFlag.const_79);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1031,_spacing,PropertyStruct.const_65,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1032,var_775,PropertyStruct.const_61,var_775 != const_1407));
         _loc1_.push(new PropertyStruct(const_1033,var_548,PropertyStruct.const_61,var_548 != const_1406));
         _loc1_.push(new PropertyStruct(const_1030,var_1113,PropertyStruct.const_61,var_1113 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_549 = param1;
            _container.y = -var_549 * maxScrollV;
            var_15.invalidate(_container,visibleRegion,WindowRedrawFlag.const_79);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1030:
                  ...
                  break;
               case const_1032:
                  var_775 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_478,param1);
            }
            else
            {
