package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_345:String = "_DROPMENU_TITLETEXT";
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_120 = context.create(name + "::submenu","",WindowType.const_396,var_78,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_437,var_78,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_299,var_78,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_465 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_465).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_475,this,null,true);
         update(this,_loc2_);
      ...
      {
         return getChildByName(DropMenuController.const_345) as ITextWindow;
      }
