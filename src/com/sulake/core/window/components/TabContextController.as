package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1106:String = "content";
      
      private static const const_1107:String = "selector";
      ...
      protected var var_1613:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1613 == null)
         {
            var_1613 = findChildByTag(TabContextController.const_1106) as IWindowContainer;
         }
         return var_1613;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_953 == null)
         {
            var_953 = findChildByTag(TabContextController.const_1107) as ITabSelectorWindow;
            if(var_953 != null)
            {
      ...
      {
         return !!var_782 ? selector.iterator : null;
      }
