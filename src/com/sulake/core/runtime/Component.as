package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_882:uint = 4;
      ...
      protected var var_1872:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_946 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_946);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1112 & const_882)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_395 + "]";
      }
   }
}
