package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_359 = _loc2_.resource;
         if(var_517)
         {
            AssetLibrary.fetchLibraryContents(this,var_516,var_359);
         }
         var_317 = true;
         dispatchEvent(new Event(AssetLibrary.const_382));
         dispatchEvent(new Event(AssetLibrary.const_869));
         if(var_517)
         {
            var_14.dispose();
            var_14 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1015,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_962,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_954,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_843,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1068.splice(var_1068.indexOf(this),1);
            --var_617;
            var_435 = null;
            var_741 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_358.length ? getAssetByName(var_358[param1]) : null;
      }
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_359[param1]);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_358.splice(var_358.indexOf(_loc2_),1);
      ...
      {
         return var_359 != null ? false : false;
      }
   }
}
