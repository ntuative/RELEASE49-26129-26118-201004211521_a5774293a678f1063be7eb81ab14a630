package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         for(_loc4_ in var_397)
         {
            _loc10_;
            if(var_397[_loc4_] == param1)
            {
               _loc3_ = _loc4_;
               break;
            }
         ...
         var _loc5_:Array = var_663[_loc3_];
      ...
      {
         var _loc3_:Array = var_663[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            var_663[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      {
         if(param1 == null || var_397 == null)
         {
            return null;
         }
         return var_397[param1] as IConnection;
      }
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in var_1162)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      public function method_7(param1:String) : IProtocol
      {
         var _loc2_:Class = var_664[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_397)
         {
            _loc2_ = _loc5_;
            _loc5_;
