package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1338:int = 10000;
      ...
      private var var_754:IEncryption;
      
      private var var_755:int;
      
      private var var_366:ByteArray;
      ...
      private var var_364:IConnectionStateListener;
      
      private var var_629:IProtocol;
      
      private var var_916:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_300 = param2;
         var_366 = new ByteArray();
         var_916 = new MessageClassManager();
         var_77 = new Socket();
         var_365 = new Timer(const_1338,1);
         var_365.addEventListener(TimerEvent.TIMER,onTimeOutTimer);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_916.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         ...
         if(var_364)
         {
            var_364.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_754 != null)
         {
            _loc3_ = var_754.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_364)
         {
            var_364.connectionInit(param1,param2);
         }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_366.writeByte(var_77.readUnsignedByte());
         }
      }
      ...
      {
         var_916.registerMessages(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_629.getMessages(var_366,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_364)
            {
               var_364.messageReceived(String(_loc5_),_loc6_.toString());
            }
            _loc7_ = var_916.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_366,_loc2_);
            var_366 = _loc18_;
         }
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_754 + "\n");
      }
   }
}
