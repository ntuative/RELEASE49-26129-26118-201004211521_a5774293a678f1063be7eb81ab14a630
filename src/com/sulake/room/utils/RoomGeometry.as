package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_718:Number = 64;
      
      public static const const_1014:Number = 32;
      ...
      private var var_2357:Number = 500;
      
      private var var_1411:Number = 1;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         x_scale = 1;
         y_scale = 1;
         var_1413 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_219.assign(param1);
         if(var_219.x != _loc2_ || var_219.y != _loc3_ || var_219.z != _loc4_)
         {
            ++var_74;
         }
      ...
      {
         if(var_390 != param1 * var_1413)
         {
            var_390 = param1 * var_1413;
            ++var_74;
         }
      }
      ...
      {
         if(var_387 != param1 * var_1412)
         {
            var_387 = param1 * var_1412;
            ++var_74;
         }
      }
      ...
      {
         if(var_388 != param1 * var_1411)
         {
            var_388 = param1 * var_1411;
            ++var_74;
         }
      }
      ...
      {
         return new Vector3d(var_219.x,var_219.y,var_219.z);
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         if(_loc3_ < var_2356 || _loc3_ > var_2357)
         {
            return null;
         }
