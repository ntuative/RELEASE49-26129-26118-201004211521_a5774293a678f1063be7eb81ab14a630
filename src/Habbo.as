package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_22:String = "client.init.swf.error";
      ...
      public static const const_23:String = "client.init.start";
      ...
      private function onPreLoadingCompleted(param1:Event) : void
      {
         ...
         catch(error:Error)
         {
            ...
            reportCrash("Failed to finalize main swf preloading: " + error.message,const_17,error);
         }
      }
      ...
      private function onVolterLoadingFailedAgain(param1:IOErrorEvent) : void
      {
         ...
         Habbo.reportCrash("Failed to download Volter.swf!",const_19,new Error(param1.text));
      }
